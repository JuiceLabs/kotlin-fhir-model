...
class DeviceComponentDataTest : DataTests() {
    @Test
    fun `devicecomponent-example 900 Test`() {
        val json = File("./src/test/resources/model/sample_data/devicecomponent-example.json").readTextAndClose()
        ...
        assertEquals("2014-10-07T14:45:00Z", obj.lastSystemChange.toString())
    ...
    @Test
    fun `devicecomponent-example-prodspec 901 Test`() {
        val json = File("./src/test/resources/model/sample_data/devicecomponent-example-prodspec.json").readTextAndClose()
        val obj = mapper.fromJson(json, DeviceComponent::class.java)
        assertTrue(stringMatch("DeviceComponent", obj.resourceType))
