...
class BasicDataTest : DataTests() {
    @Test
    fun `basic-example2 870 Test`() {
        val json = File("./src/test/resources/model/sample_data/basic-example2.json").readTextAndClose()
    ...
    @Test
    fun `basic-example-narrative 871 Test`() {
        val json = File("./src/test/resources/model/sample_data/basic-example-narrative.json").readTextAndClose()
        val obj = mapper.fromJson(json, Basic::class.java)
        assertTrue(stringMatch("Basic", obj.resourceType))
    ...
    @Test
    fun `basic-example 872 Test`() {
        val json = File("./src/test/resources/model/sample_data/basic-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Basic::class.java)
        assertTrue(stringMatch("Basic", obj.resourceType))
    ...
    @Test
    fun `basic-example 873 Test`() {
        val json = File("./src/test/resources/model/sample_data/basic-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Basic::class.java)
        assertTrue(stringMatch("http://example.org/do-not-use", obj.modifierExtension[1].url))
        assertEquals("2013-04-01", obj.modifierExtension[1].valuePeriod!!.start.toString())
        assertEquals("2013-04-15", obj.modifierExtension[1].valuePeriod!!.end.toString())
        ...
        assertEquals("2013-05-14", obj.created.toString())
