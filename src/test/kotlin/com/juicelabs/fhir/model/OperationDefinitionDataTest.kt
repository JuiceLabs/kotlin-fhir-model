...
class OperationDefinitionDataTest : DataTests() {
    @Test
    fun `operationdefinition-example 990 Test`() {
        val json = File("./src/test/resources/model/sample_data/operationdefinition-example.json").readTextAndClose()
    ...
    @Test
    fun `operationdefinition-example 991 Test`() {
        val json = File("./src/test/resources/model/sample_data/operationdefinition-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, OperationDefinition::class.java)
