...
class ImplementationGuideDataTest : DataTests() {
    @Test
    fun `implementationguide-example 722 Test`() {
        val json = File("./src/test/resources/model/sample_data/implementationguide-example.json").readTextAndClose()
        ...
        assertEquals("2015-01-01", obj.date.toString())
    ...
    @Test
    fun `implementationguide-example 723 Test`() {
        val json = File("./src/test/resources/model/sample_data/implementationguide-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, ImplementationGuide::class.java)
