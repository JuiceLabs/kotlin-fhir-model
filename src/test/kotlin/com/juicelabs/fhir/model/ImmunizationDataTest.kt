...
class ImmunizationDataTest : DataTests() {
    @Test
    fun `immunization-example 759 Test`() {
        val json = File("./src/test/resources/model/sample_data/immunization-example.json").readTextAndClose()
        ...
        assertEquals("2013-01-10", obj.date.toString())
        ...
        assertEquals("2015-02-15", obj.expirationDate.toString())
        ...
        assertEquals("2013-01-10", obj.reaction[0].date.toString())
    ...
    @Test
    fun `immunization-example-historical 760 Test`() {
        val json = File("./src/test/resources/model/sample_data/immunization-example-historical.json").readTextAndClose()
        val obj = mapper.fromJson(json, Immunization::class.java)
        assertTrue(stringMatch("Immunization", obj.resourceType))
    ...
    @Test
    fun `immunization-example-historical 761 Test`() {
        val json = File("./src/test/resources/model/sample_data/immunization-example-historical.json").readTextAndClose()
        val obj = mapper.fromJson(json, Immunization::class.java)
        assertTrue(stringMatch("Influenza", obj.vaccineCode.text))
        assertTrue(stringMatch("Patient/example", obj.patient.reference))
        assertEquals("2012-01-15", obj.date.toString())
    ...
    @Test
    fun `immunization-example-refused 762 Test`() {
        val json = File("./src/test/resources/model/sample_data/immunization-example-refused.json").readTextAndClose()
        val obj = mapper.fromJson(json, Immunization::class.java)
        assertTrue(stringMatch("Immunization", obj.resourceType))
