...
class MeasureDataTest : DataTests() {
    ...
    fun `measure-component-b-example 482 Test`() {
        val json = File("./src/test/resources/model/sample_data/measure-component-b-example.json").readTextAndClose()
    ...
    fun `measure-predecessor-example 483 Test`() {
        val json = File("./src/test/resources/model/sample_data/measure-predecessor-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Measure::class.java)
        assertTrue(stringMatch("Measure", obj.resourceType))
    ...
    fun `measure-cms146-example 484 Test`() {
        val json = File("./src/test/resources/model/sample_data/measure-cms146-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Measure::class.java)
        assertTrue(stringMatch("Measure", obj.resourceType))
    ...
    fun `measure-component-a-example 485 Test`() {
        val json = File("./src/test/resources/model/sample_data/measure-component-a-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Measure::class.java)
        assertTrue(stringMatch("Measure", obj.resourceType))
    ...
    fun `measure-composite-example 486 Test`() {
        val json = File("./src/test/resources/model/sample_data/measure-composite-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Measure::class.java)
        assertTrue(stringMatch("Measure", obj.resourceType))
