...
class MeasureDataTest : DataTests() {
    @Test
    fun `measure-component-b-example 843 Test`() {
    ...
    @Test
    fun `measure-predecessor-example 844 Test`() {
        ...
        assertEquals("2014-03-08", obj.date.toString())
    ...
    @Test
    fun `measure-predecessor-example 845 Test`() {
        val json = File("./src/test/resources/model/sample_data/measure-predecessor-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Measure::class.java)
    ...
    @Test
    fun `measure-cms146-example 846 Test`() {
        ...
        assertEquals("2017-03-10", obj.date.toString())
        ...
        assertEquals("2016-01-01", obj.approvalDate.toString())
        assertEquals("2016-09-01", obj.lastReviewDate.toString())
        assertEquals("2017-01-01", obj.effectivePeriod!!.start.toString())
    ...
    @Test
    fun `measure-cms146-example 847 Test`() {
        val json = File("./src/test/resources/model/sample_data/measure-cms146-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Measure::class.java)
    ...
    @Test
    fun `measure-component-a-example 848 Test`() {
    ...
    @Test
    fun `measure-composite-example 849 Test`() {
