...
class EndpointDataTest : DataTests() {
    @Test
    fun `endpoint-example-iid 755 Test`() {
        val json = File("./src/test/resources/model/sample_data/endpoint-example-iid.json").readTextAndClose()
    ...
    @Test
    fun `endpoint-example-wadors 756 Test`() {
        val json = File("./src/test/resources/model/sample_data/endpoint-example-wadors.json").readTextAndClose()
        val obj = mapper.fromJson(json, Endpoint::class.java)
        assertTrue(stringMatch("Endpoint", obj.resourceType))
    ...
    @Test
    fun `endpoint-example 757 Test`() {
        val json = File("./src/test/resources/model/sample_data/endpoint-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Endpoint::class.java)
        assertTrue(stringMatch("Endpoint", obj.resourceType))
