...
class PatientDataTest : DataTests() {
    @Test
    fun `patient-example-xds 109 Test`() {
        ...
        assertEquals("1956-05-27", obj.birthDate.toString())
    ...
    @Test
    fun `patient-example-f001-pieter 110 Test`() {
        ...
        assertTrue(stringMatch("male", obj.gender))
        assertEquals("1944-11-17", obj.birthDate.toString())
    ...
    @Test
    fun `patient-example-d 111 Test`() {
    ...
    @Test
    fun `patient-example-d 112 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-d.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("generated", obj.text!!.status))
        assertTrue(stringMatch("<div xmlns=\"http://www.w3.org", obj.text!!.div))
        ...
        assertEquals("1982-08-02", obj.birthDate.toString())
    ...
    @Test
    fun `patient-genetics-example1 113 Test`() {
        ...
        assertTrue(stringMatch("female", obj.gender))
        assertEquals("1973-05-31", obj.birthDate.toString())
        assertTrue(stringMatch("home", obj.address[0].use))
    ...
    @Test
    fun `patient-example-b 114 Test`() {
    ...
    @Test
    fun `patient-example-c 115 Test`() {
    ...
    @Test
    fun `patient-example-c 116 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-c.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("male", obj.gender))
        assertEquals("1982-01-23", obj.birthDate.toString())
        assertEquals("2015-02-14T13:42:00+10:00", obj.deceasedDateTime.toString())
        assertTrue(stringMatch("Organization/1", obj.managingOrganization!!.reference))
        assertTrue(stringMatch("ACME Healthcare, Inc", obj.managingOrganization!!.display))
    }

    @Test
    fun `patient-example-ihe-pcd 117 Test`() {
    ...
    fun `patient-example 118 Test`() {
        ...
        assertEquals("2002", obj.name[2].period!!.end.toString())
        ...
        assertEquals("2014", obj.telecom[3].period!!.end.toString())
        assertTrue(stringMatch("male", obj.gender))
        ...
        assertEquals("1974-12-25", obj.address[0].period!!.start.toString())
        assertTrue(stringMatch("http://hl7.org/fhir/v2/0131", obj.contact[0].relationship[0].coding[0].system))
    ...
    fun `patient-example 119 Test`() {
        ...
        assertEquals("1974-12-25", obj.contact[0].address!!.period!!.start.toString())
        assertTrue(stringMatch("female", obj.contact[0].gender))
        assertEquals("2012", obj.contact[0].period!!.start.toString())
        assertTrue(stringMatch("Organization/1", obj.managingOrganization!!.reference))
    }

    @Test
    fun `patient-example-proband 120 Test`() {
        ...
        assertEquals(true, if (obj.active != null) obj.active else false, "Field: obj.active")
        assertTrue(stringMatch("female", obj.gender))
        assertEquals("1966-04-04", obj.birthDate.toString())
        assertEquals(false, if (obj.deceasedBoolean != null) obj.deceasedBoolean else false, "Field: obj.deceasedBoolean")
    }

    @Test
    fun `patient-example-f201-roel 121 Test`() {
        ...
        assertTrue(stringMatch("home", obj.telecom[1].use))
        assertTrue(stringMatch("male", obj.gender))
        assertEquals("1960-03-13", obj.birthDate.toString())
        assertEquals(false, if (obj.deceasedBoolean != null) obj.deceasedBoolean else false, "Field: obj.deceasedBoolean")
        assertTrue(stringMatch("home", obj.address[0].use))
    ...
    @Test
    fun `patient-example-f201-roel 122 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-f201-roel.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("phone", obj.contact[0].telecom[0].system))
    ...
    @Test
    fun `patient-example-xcda 123 Test`() {
        ...
        assertTrue(stringMatch("male", obj.gender))
        assertEquals("1932-09-24", obj.birthDate.toString())
    ...
    @Test
    fun `patient-example-a 124 Test`() {
    ...
    @Test
    fun `patient-example-dicom 125 Test`() {
    ...
    @Test
    fun `patient-example-animal 126 Test`() {
    ...
    @Test
    fun `patient-example-animal 127 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-animal.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("<div xmlns=\"http://www.w3.org", obj.text!!.div))
        ...
        assertEquals("2010-05-31", obj.identifier[0].period!!.start.toString())
        ...
        assertTrue(stringMatch("female", obj.gender))
        assertEquals("2010-03-23", obj.birthDate.toString())
        assertTrue(stringMatch("http://hl7.org/fhir/v2/0131", obj.contact[0].relationship[0].coding[0].system))
        assertTrue(stringMatch("C", obj.contact[0].relationship[0].coding[0].code))
    ...
    @Test
    fun `patient-example-chinese 128 Test`() {
        ...
        assertEquals("2016-05-16T00:55:52Z", obj.meta!!.lastUpdated.toString())
        assertTrue(stringMatch("generated", obj.text!!.status))
        assertTrue(stringMatch("<div xmlns=\"http://www.w3.org", obj.text!!.div))
        assertTrue(stringMatch("usual", obj.identifier[0].use))
        assertTrue(stringMatch("http://hl7.org/fhir/v2/0203", obj.identifier[0].type!!.coding[0].system))
    ...
    @Test
    fun `patient-glossy-example 129 Test`() {
        ...
        assertEquals("2014-11-13T11:41:00+11:00", obj.meta!!.lastUpdated.toString())
        assertTrue(stringMatch("generated", obj.text!!.status))
        assertTrue(stringMatch("<div xmlns=\"http://www.w3.org", obj.text!!.div))
    ...
    @Test
    fun `patient-glossy-example 130 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-glossy-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("http://hl7.org/fhir/v2/0203", obj.identifier[0].type!!.coding[0].system))
        assertTrue(stringMatch("MR", obj.identifier[0].type!!.coding[0].code))
