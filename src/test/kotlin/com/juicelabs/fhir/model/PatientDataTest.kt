...
class PatientDataTest : DataTests() {
    ...
    fun `patient-example-xds 77 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-xds.json").readTextAndClose()
    ...
    fun `patient-example-f001-pieter 78 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-f001-pieter.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-example-d 79 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-d.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-genetics-example1 80 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-genetics-example1.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-example-b 81 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-b.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-example-c 82 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-c.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-example-ihe-pcd 83 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-ihe-pcd.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-example 84 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-example-proband 85 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-proband.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-example-f201-roel 86 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-f201-roel.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-example-xcda 87 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-xcda.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-example-a 88 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-a.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-example-dicom 89 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-dicom.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-example-animal 90 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-animal.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-example-chinese 92 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-example-chinese.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
    ...
    fun `patient-glossy-example 93 Test`() {
        val json = File("./src/test/resources/model/sample_data/patient-glossy-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Patient::class.java)
        assertTrue(stringMatch("Patient", obj.resourceType))
