...
class DataElementDataTest : DataTests() {
    @Test
    fun `dataelement-example 973 Test`() {
        ...
        assertEquals("2016-01-01", obj.date.toString())
    ...
    @Test
    fun `dataelement-example 974 Test`() {
        val json = File("./src/test/resources/model/sample_data/dataelement-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, DataElement::class.java)
    ...
    @Test
    fun `dataelement-labtestmaster-example 975 Test`() {
        ...
        assertEquals("2011-05-19", obj.identifier[0].period!!.start.toString())
