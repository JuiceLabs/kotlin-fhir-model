...
class PersonDataTest : DataTests() {
    @Test
    fun `person-example-f002-ariadne 752 Test`() {
        val json = File("./src/test/resources/model/sample_data/person-example-f002-ariadne.json").readTextAndClose()
    ...
    @Test
    fun `person-example-f002-ariadne 753 Test`() {
        val json = File("./src/test/resources/model/sample_data/person-example-f002-ariadne.json").readTextAndClose()
        val obj = mapper.fromJson(json, Person::class.java)
    ...
    @Test
    fun `person-example 754 Test`() {
        val json = File("./src/test/resources/model/sample_data/person-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Person::class.java)
        assertTrue(stringMatch("Person", obj.resourceType))
        ...
        assertEquals("2001-05-06", obj.identifier[0].period!!.start.toString())
        ...
        assertEquals("1974-12-25", obj.birthDate.toString())
