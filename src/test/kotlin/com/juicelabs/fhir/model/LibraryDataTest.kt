...
class LibraryDataTest : DataTests() {
    ...
    fun `library-predecessor-example 534 Test`() {
        val json = File("./src/test/resources/model/sample_data/library-predecessor-example.json").readTextAndClose()
    ...
    fun `library-cms146-example 535 Test`() {
        val json = File("./src/test/resources/model/sample_data/library-cms146-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Library::class.java)
        assertTrue(stringMatch("Library", obj.resourceType))
    ...
    fun `library-example 536 Test`() {
        val json = File("./src/test/resources/model/sample_data/library-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Library::class.java)
        assertTrue(stringMatch("Library", obj.resourceType))
    ...
    fun `library-composition-example 537 Test`() {
        val json = File("./src/test/resources/model/sample_data/library-composition-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Library::class.java)
        assertTrue(stringMatch("Library", obj.resourceType))
