...
class DeviceRequestDataTest : DataTests() {
    @Test
    fun `devicerequest-example-insulinpump 720 Test`() {
        val json = File("./src/test/resources/model/sample_data/devicerequest-example-insulinpump.json").readTextAndClose()
        ...
        assertEquals("2013-05-08T09:33:27+07:00", obj.occurrenceDateTime.toString())
        assertEquals("2013-05-08T09:33:27+07:00", obj.authoredOn.toString())
    ...
    @Test
    fun `devicerequest-example 721 Test`() {
        val json = File("./src/test/resources/model/sample_data/devicerequest-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, DeviceRequest::class.java)
        assertTrue(stringMatch("DeviceRequest", obj.resourceType))
