...
class GuidanceResponseDataTest : DataTests() {
    @Test
    fun `guidanceresponse-example 992 Test`() {
        val json = File("./src/test/resources/model/sample_data/guidanceresponse-example.json").readTextAndClose()
        ...
        assertEquals("2017-03-10T16:02:00Z", obj.occurrenceDateTime.toString())
