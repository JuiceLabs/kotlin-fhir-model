...
class MedicationDataTest : DataTests() {
    ...
    fun `medicationexample0307 281 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0307.json").readTextAndClose()
    ...
    fun `medicationexample0311 282 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0311.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0310 283 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0310.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0306 285 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0306.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0301 286 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0301.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0317 287 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0317.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample1 288 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample1.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample15 289 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample15.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0321 290 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0321.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0320 291 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0320.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0316 292 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0316.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0315 293 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0315.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0303 294 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0303.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0319 295 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0319.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0318 296 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0318.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0302 297 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0302.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0314 298 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0314.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0309 299 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0309.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0313 300 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0313.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0305 301 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0305.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0304 302 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0304.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0312 303 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0312.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
    ...
    fun `medicationexample0308 305 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0308.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Medication", obj.resourceType))
