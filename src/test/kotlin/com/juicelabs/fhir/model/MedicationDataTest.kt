...
class MedicationDataTest : DataTests() {
    @Test
    fun `medicationexample0307 577 Test`() {
    ...
    @Test
    fun `medicationexample0307 578 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0307.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        ...
        assertEquals("2019-10-31", obj.package_fhir!!.batch[0].expirationDate.toString())
    }

    @Test
    fun `medicationexample0311 579 Test`() {
    ...
    @Test
    fun `medicationexample0310 580 Test`() {
    ...
    @Test
    fun `medicationexample0310 581 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0310.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("http://hl7.org/fhir/v3/ordera", obj.ingredient[0].amount!!.denominator!!.system))
        assertTrue(stringMatch("TAB", obj.ingredient[0].amount!!.denominator!!.code))
    ...
    @Test
    fun `medicationexample0306 582 Test`() {
    ...
    @Test
    fun `medicationexample0301 583 Test`() {
        ...
        assertEquals("2017-05-22", obj.package_fhir!!.batch[0].expirationDate.toString())
    ...
    @Test
    fun `medicationexample0317 584 Test`() {
    ...
    @Test
    fun `medicationexample0317 585 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0317.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
    ...
    @Test
    fun `medicationexample1 586 Test`() {
    ...
    @Test
    fun `medicationexample15 587 Test`() {
    ...
    @Test
    fun `medicationexample0321 588 Test`() {
    ...
    @Test
    fun `medicationexample0321 589 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0321.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("Tablet dose form (qualifier v", obj.form!!.coding[0].display))
        assertTrue(stringMatch("#sub03", obj.ingredient[0].itemReference.reference))
    ...
    @Test
    fun `medicationexample0320 590 Test`() {
    ...
    @Test
    fun `medicationexample0316 591 Test`() {
    ...
    @Test
    fun `medicationexample0315 592 Test`() {
    ...
    @Test
    fun `medicationexample0303 593 Test`() {
    ...
    @Test
    fun `medicationexample0303 594 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0303.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
    ...
    @Test
    fun `medicationexample0319 595 Test`() {
    ...
    @Test
    fun `medicationexample0318 596 Test`() {
    ...
    @Test
    fun `medicationexample0318 597 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0318.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        ...
        assertEquals("2016-07-09", obj.package_fhir!!.batch[0].expirationDate.toString())
    }

    @Test
    fun `medicationexample0302 598 Test`() {
    ...
    @Test
    fun `medicationexample0314 599 Test`() {
    ...
    @Test
    fun `medicationexample0309 600 Test`() {
    ...
    @Test
    fun `medicationexample0309 601 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0309.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("generated", obj.text!!.status))
        assertTrue(stringMatch("<div xmlns=\"http://www.w3.org", obj.text!!.div))
    ...
    @Test
    fun `medicationexample0313 602 Test`() {
    ...
    @Test
    fun `medicationexample0305 603 Test`() {
    ...
    @Test
    fun `medicationexample0305 604 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0305.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
        assertTrue(stringMatch("%.2f".format(5f), "%.2f".format(obj.ingredient[0].amount!!.numerator!!.value)))
        assertTrue(stringMatch("http://unitsofmeasure.org", obj.ingredient[0].amount!!.numerator!!.system))
    ...
    @Test
    fun `medicationexample0304 605 Test`() {
    ...
    @Test
    fun `medicationexample0312 606 Test`() {
    ...
    @Test
    fun `medicationexample0312 607 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationexample0312.json").readTextAndClose()
        val obj = mapper.fromJson(json, Medication::class.java)
    ...
    @Test
    fun `medicationexample0308 608 Test`() {
        ...
        assertEquals("2020-07-31", obj.package_fhir!!.batch[0].expirationDate.toString())
    }
}
