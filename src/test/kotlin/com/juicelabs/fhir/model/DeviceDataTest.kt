...
class DeviceDataTest : DataTests() {
    @Test
    fun `device-example-software 154 Test`() {
        val json = File("./src/test/resources/model/sample_data/device-example-software.json").readTextAndClose()
    ...
    @Test
    fun `device-example-udi3 155 Test`() {
        val json = File("./src/test/resources/model/sample_data/device-example-udi3.json").readTextAndClose()
        val obj = mapper.fromJson(json, Device::class.java)
        assertTrue(stringMatch("Device", obj.resourceType))
        ...
        assertEquals("2013-02-02", obj.manufactureDate.toString())
        assertEquals("2020-02-02", obj.expirationDate.toString())
        assertTrue(stringMatch("Ultra Implantable", obj.model))
        assertTrue(stringMatch("Patient/example", obj.patient!!.reference))
    }

    @Test
    fun `device-example-udi2 156 Test`() {
        val json = File("./src/test/resources/model/sample_data/device-example-udi2.json").readTextAndClose()
        val obj = mapper.fromJson(json, Device::class.java)
        assertTrue(stringMatch("Device", obj.resourceType))
        ...
        assertTrue(stringMatch("inactive", obj.status))
        assertTrue(stringMatch("Acme Devices, Inc", obj.manufacturer))
        assertEquals("2013-02-01", obj.manufactureDate.toString())
        assertEquals("2014-02-01", obj.expirationDate.toString())
        assertTrue(stringMatch("Patient/example", obj.patient!!.reference))
    }

    @Test
    fun `device-example-f001-feedingtube 157 Test`() {
        val json = File("./src/test/resources/model/sample_data/device-example-f001-feedingtube.json").readTextAndClose()
        val obj = mapper.fromJson(json, Device::class.java)
        assertTrue(stringMatch("Device", obj.resourceType))
        ...
        assertEquals("2015-08-08", obj.manufactureDate.toString())
        assertEquals("2020-08-08", obj.expirationDate.toString())
    }

    @Test
    fun `device-example-f001-feedingtube 158 Test`() {
        val json = File("./src/test/resources/model/sample_data/device-example-f001-feedingtube.json").readTextAndClose()
        val obj = mapper.fromJson(json, Device::class.java)
    ...
    @Test
    fun `device-example-pacemaker 159 Test`() {
        val json = File("./src/test/resources/model/sample_data/device-example-pacemaker.json").readTextAndClose()
        val obj = mapper.fromJson(json, Device::class.java)
        assertTrue(stringMatch("Device", obj.resourceType))
    ...
    @Test
    fun `device-example-udi4 160 Test`() {
        val json = File("./src/test/resources/model/sample_data/device-example-udi4.json").readTextAndClose()
        val obj = mapper.fromJson(json, Device::class.java)
        assertTrue(stringMatch("Device", obj.resourceType))
    ...
    @Test
    fun `device-example-ihe-pcd 161 Test`() {
        val json = File("./src/test/resources/model/sample_data/device-example-ihe-pcd.json").readTextAndClose()
        val obj = mapper.fromJson(json, Device::class.java)
        assertTrue(stringMatch("Device", obj.resourceType))
    ...
    @Test
    fun `device-example 162 Test`() {
        val json = File("./src/test/resources/model/sample_data/device-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Device::class.java)
        assertTrue(stringMatch("Device", obj.resourceType))
        ...
        assertEquals("2015-06-28T14:03:32+10:00", obj.note[0].time.toString())
        assertTrue(stringMatch("QA Checked", obj.note[0].text))
    }

    @Test
    fun `device-example-udi1 163 Test`() {
        val json = File("./src/test/resources/model/sample_data/device-example-udi1.json").readTextAndClose()
        val obj = mapper.fromJson(json, Device::class.java)
        assertTrue(stringMatch("Device", obj.resourceType))
    ...
    @Test
    fun `device-example-udi1 164 Test`() {
        val json = File("./src/test/resources/model/sample_data/device-example-udi1.json").readTextAndClose()
        val obj = mapper.fromJson(json, Device::class.java)
        ...
        assertTrue(stringMatch("Acme Devices, Inc", obj.manufacturer))
        assertEquals("2014-11-20", obj.expirationDate.toString())
        assertTrue(stringMatch("PM/Octane 2014", obj.model))
        assertTrue(stringMatch("Patient/example", obj.patient!!.reference))
