...
class ObservationDataTest : DataTests() {
    @Test
    fun `observation-example-genetics-1 12 Test`() {
    ...
    @Test
    fun `observation-example-genetics-1 13 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-genetics-1.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        ...
        assertEquals("2013-04-03T15:30:10+01:00", obj.issued.toString())
    ...
    @Test
    fun `observation-example-bmd 14 Test`() {
    ...
    @Test
    fun `observation-example-respiratory-rate 15 Test`() {
        ...
        assertTrue(stringMatch("Patient/example", obj.subject!!.reference))
        assertEquals("1999-07-02", obj.effectiveDateTime.toString())
    ...
    @Test
    fun `observation-example 16 Test`() {
    ...
    @Test
    fun `observation-example 17 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertTrue(stringMatch("http://loinc.org", obj.code.coding[0].system))
        ...
        assertEquals("2016-03-28", obj.effectiveDateTime.toString())
    ...
    @Test
    fun `observation-example-haplotype2 18 Test`() {
    ...
    @Test
    fun `observation-example-mbp 19 Test`() {
    ...
    @Test
    fun `observation-example-bmi 20 Test`() {
    ...
    @Test
    fun `observation-example-bmi 21 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-bmi.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertTrue(stringMatch("final", obj.status))
        assertTrue(stringMatch("http://hl7.org/fhir/observati", obj.category[0].coding[0].system))
    ...
    @Test
    fun `observation-example-body-height 22 Test`() {
    ...
    @Test
    fun `observation-example-eye-color 23 Test`() {
        ...
        assertTrue(stringMatch("Patient/example", obj.subject!!.reference))
        assertEquals("2016-05-18", obj.effectiveDateTime.toString())
        assertTrue(stringMatch("blue", obj.valueString))
    }

    @Test
    fun `observation-example-body-temperature 24 Test`() {
    ...
    @Test
    fun `observation-example-TPMT-diplotype 25 Test`() {
    ...
    @Test
    fun `observation-example-TPMT-diplotype 26 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-TPMT-diplotype.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
    ...
    @Test
    fun `observation-example-f002-excess 27 Test`() {
        ...
        assertEquals("2013-04-02T10:30:10+01:00", obj.effectivePeriod!!.start.toString())
        assertEquals("2013-04-05T10:30:10+01:00", obj.effectivePeriod!!.end.toString())
        assertEquals("2013-04-03T15:30:10+01:00", obj.issued.toString())
    ...
    @Test
    fun `observation-example-vitals-panel 28 Test`() {
    ...
    @Test
    fun `observation-example-vitals-panel 29 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-vitals-panel.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
    ...
    @Test
    fun `observation-example-phenotype 30 Test`() {
    ...
    @Test
    fun `observation-example-head-circumference 31 Test`() {
    ...
    @Test
    fun `observation-example-TPMT-haplotype-two 32 Test`() {
    ...
    @Test
    fun `observation-example-f206-staphylococcus 33 Test`() {
    ...
    @Test
    fun `observation-example-f206-staphylococcus 34 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-f206-staphylococcus.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertTrue(stringMatch("final", obj.status))
    ...
    @Test
    fun `observation-example-bloodpressure-cancel 35 Test`() {
        ...
        assertTrue(stringMatch("Patient/example", obj.subject!!.reference))
        assertEquals("2012-09-17", obj.effectiveDateTime.toString())
        assertTrue(stringMatch("Practitioner/example", obj.performer[0].reference))
        assertTrue(stringMatch("http://hl7.org/fhir/v2/0078", obj.interpretation!!.coding[0].system))
    ...
    @Test
    fun `observation-example-date-lastmp 36 Test`() {
    ...
    @Test
    fun `observation-example-date-lastmp 37 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-date-lastmp.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        ...
        assertTrue(stringMatch("Patient/pat2", obj.subject!!.reference))
        assertEquals("2016-01-24", obj.effectiveDateTime.toString())
        assertEquals("2016-12-30", obj.valueDateTime.toString())
    }

    @Test
    fun `observation-example-glasgow 38 Test`() {
        ...
        assertEquals("2014-12-11T04:44:16Z", (obj.contained[0] as Observation).effectiveDateTime.toString())
        ...
        assertEquals("2014-12-11T04:44:16Z", (obj.contained[1] as Observation).effectiveDateTime.toString())
        ...
        assertEquals("2014-12-11T04:44:16Z", (obj.contained[2] as Observation).effectiveDateTime.toString())
    ...
    @Test
    fun `observation-example-glasgow 39 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-glasgow.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        ...
        assertEquals("2014-12-11T04:44:16Z", obj.effectiveDateTime.toString())
    ...
    @Test
    fun `observation-example-10minute-apgar-score 40 Test`() {
        ...
        assertEquals("2016-05-18", (obj.contained[0] as Patient).birthDate.toString())
        assertTrue(stringMatch("final", obj.status))
        assertTrue(stringMatch("http://hl7.org/fhir/observati", obj.category[0].coding[0].system))
        assertTrue(stringMatch("survey", obj.category[0].coding[0].code))
        assertTrue(stringMatch("Survey", obj.category[0].coding[0].display))
        ...
        assertEquals("2016-05-18T22:33:22Z", obj.effectiveDateTime.toString())
        assertTrue(stringMatch("Practitioner/example", obj.performer[0].reference))
    ...
    @Test
    fun `observation-example-10minute-apgar-score 41 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-10minute-apgar-score.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
    ...
    @Test
    fun `observation-example-satO2 42 Test`() {
    ...
    @Test
    fun `observation-example-satO2 43 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-satO2.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertTrue(stringMatch("<div xmlns=\"http://www.w3.org", obj.text!!.div))
        ...
        assertTrue(stringMatch("Patient/example", obj.subject!!.reference))
        assertEquals("2014-12-05T09:30:10+01:00", obj.effectiveDateTime.toString())
    ...
    @Test
    fun `observation-example-glasgow-qa 44 Test`() {
    ...
    @Test
    fun `observation-example-TPMT-haplotype-one 45 Test`() {
    ...
    @Test
    fun `observation-example-TPMT-haplotype-one 46 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-TPMT-haplotype-one.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertTrue(stringMatch("http://www.genenames.org", obj.extension[0].valueCodeableConcept!!.coding[0].system))
        assertTrue(stringMatch("12014", obj.extension[0].valueCodeableConcept!!.coding[0].code))
    ...
    @Test
    fun `observation-example-f004-erythrocyte 47 Test`() {
    ...
    @Test
    fun `observation-example-genetics-5 48 Test`() {
    ...
    @Test
    fun `observation-example-f204-creatinine 49 Test`() {
    ...
    @Test
    fun `observation-example-f204-creatinine 50 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-f204-creatinine.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertEquals("2013-04-04T14:34:00+01:00", obj.issued.toString())
        assertTrue(stringMatch("Practitioner/f202", obj.performer[0].reference))
        assertTrue(stringMatch("Luigi Maas", obj.performer[0].display))
    ...
    @Test
    fun `observation-example-genetics-4 51 Test`() {
    ...
    @Test
    fun `observation-example-sample-data 52 Test`() {
        ...
        assertTrue(stringMatch("Patient/f001", obj.subject!!.reference))
        assertTrue(stringMatch("P. van de Heuvel", obj.subject!!.display))
        assertEquals("2015-02-19T09:30:35+01:00", obj.effectiveDateTime.toString())
        assertTrue(stringMatch("Practitioner/f005", obj.performer[0].reference))
        assertTrue(stringMatch("A. Langeveld", obj.performer[0].display))
    ...
    @Test
    fun `observation-example-sample-data 53 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-sample-data.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
    ...
    @Test
    fun `observation-example-f005-hemoglobin 54 Test`() {
        ...
        assertTrue(stringMatch("Patient/f001", obj.subject!!.reference))
        assertTrue(stringMatch("P. van de Heuvel", obj.subject!!.display))
        assertEquals("2013-04-05T10:30:10+01:00", obj.effectivePeriod!!.start.toString())
        assertEquals("2013-04-05T10:30:10+01:00", obj.effectivePeriod!!.end.toString())
        assertEquals("2013-04-05T15:30:10+01:00", obj.issued.toString())
        assertTrue(stringMatch("Practitioner/f005", obj.performer[0].reference))
        assertTrue(stringMatch("A. Langeveld", obj.performer[0].display))
    ...
    @Test
    fun `observation-example-f003-co2 55 Test`() {
    ...
    @Test
    fun `observation-example-f003-co2 56 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-f003-co2.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertTrue(stringMatch("http://unitsofmeasure.org", obj.valueQuantity!!.system))
    ...
    @Test
    fun `observation-example-1minute-apgar-score 57 Test`() {
    ...
    @Test
    fun `observation-example-1minute-apgar-score 58 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-1minute-apgar-score.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
    ...
    @Test
    fun `observation-example-genetics-3 59 Test`() {
    ...
    @Test
    fun `observation-example-bloodpressure 60 Test`() {
    ...
    @Test
    fun `observation-example-bloodpressure 61 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-bloodpressure.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
    ...
    @Test
    fun `observation-example-haplotype1 62 Test`() {
    ...
    @Test
    fun `observation-example-haplotype1 63 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-haplotype1.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertTrue(stringMatch("Molecular Specimen ID: MLD45-", obj.specimen!!.display))
        assertTrue(stringMatch("derived-from", obj.related[0].type))
    ...
    @Test
    fun `observation-example-body-length 64 Test`() {
    ...
    @Test
    fun `observation-example-5minute-apgar-score 65 Test`() {
    ...
    @Test
    fun `observation-example-5minute-apgar-score 66 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-5minute-apgar-score.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertTrue(stringMatch("2. Good color all over", obj.component[0].valueCodeableConcept!!.text))
        assertTrue(stringMatch("http://loinc.org", obj.component[1].code.coding[0].system))
    ...
    @Test
    fun `observation-example-diplotype1 67 Test`() {
    ...
    @Test
    fun `observation-example-diplotype1 68 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-diplotype1.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertTrue(stringMatch("363779003", obj.code.coding[0].code))
        assertTrue(stringMatch("Genotype determination", obj.code.coding[0].display))
    ...
    @Test
    fun `observation-example-heart-rate 69 Test`() {
    ...
    @Test
    fun `observation-example-bloodpressure-dar 70 Test`() {
    ...
    @Test
    fun `observation-example-bloodpressure-dar 71 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-bloodpressure-dar.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertTrue(stringMatch("8462-4", obj.component[1].code.coding[0].code))
        assertTrue(stringMatch("Diastolic blood pressure", obj.component[1].code.coding[0].display))
    ...
    @Test
    fun `observation-example-f202-temperature 72 Test`() {
        ...
        assertTrue(stringMatch("Patient/f201", obj.subject!!.reference))
        assertTrue(stringMatch("Roel", obj.subject!!.display))
        assertEquals("2013-04-04T13:27:00+01:00", obj.issued.toString())
    ...
    @Test
    fun `observation-example-20minute-apgar-score 73 Test`() {
    ...
    @Test
    fun `observation-example-20minute-apgar-score 74 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-20minute-apgar-score.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertTrue(stringMatch("http://unitsofmeasure.org", obj.valueQuantity!!.system))
        assertTrue(stringMatch("{score}", obj.valueQuantity!!.code))
    ...
    @Test
    fun `observation-example-f001-glucose 75 Test`() {
    ...
    @Test
    fun `observation-example-f001-glucose 76 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-f001-glucose.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        ...
        assertTrue(stringMatch("Patient/f001", obj.subject!!.reference))
        assertTrue(stringMatch("P. van de Heuvel", obj.subject!!.display))
        assertEquals("2013-04-02T09:30:10+01:00", obj.effectivePeriod!!.start.toString())
        assertEquals("2013-04-03T15:30:10+01:00", obj.issued.toString())
        assertTrue(stringMatch("Practitioner/f005", obj.performer[0].reference))
        assertTrue(stringMatch("A. Langeveld", obj.performer[0].display))
    ...
    @Test
    fun `observation-example-f203-bicarbonate 77 Test`() {
    ...
    @Test
    fun `observation-example-unsat 78 Test`() {
        ...
        assertTrue(stringMatch("P. van de Heuvel", obj.subject!!.display))
        assertEquals("2013-04-02T09:30:10+01:00", obj.effectivePeriod!!.start.toString())
        assertEquals("2013-04-05T09:30:10+01:00", obj.effectivePeriod!!.end.toString())
    }

    @Test
    fun `observation-example-unsat 79 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-unsat.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertEquals("2013-04-03T15:30:10+01:00", obj.issued.toString())
        assertTrue(stringMatch("Practitioner/f005", obj.performer[0].reference))
    ...
    @Test
    fun `observation-example-2minute-apgar-score 80 Test`() {
    ...
    @Test
    fun `observation-example-2minute-apgar-score 81 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-2minute-apgar-score.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
        assertTrue(stringMatch("Apgar response to stimulus sc", obj.component[2].code.text))
        assertTrue(stringMatch("http://hl7.org/fhir/Structure", obj.component[2].valueCodeableConcept!!.coding[0].extension[0].url))
    ...
    @Test
    fun `observation-example-genetics-2 82 Test`() {
    ...
    @Test
    fun `observation-example-f205-egfr 83 Test`() {
    ...
    @Test
    fun `observation-example-f205-egfr 84 Test`() {
        val json = File("./src/test/resources/model/sample_data/observation-example-f205-egfr.json").readTextAndClose()
        val obj = mapper.fromJson(json, Observation::class.java)
