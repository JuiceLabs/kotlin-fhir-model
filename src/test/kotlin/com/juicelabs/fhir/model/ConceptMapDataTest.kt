...
class ConceptMapDataTest : DataTests() {
    @Test
    fun `conceptmap-example 881 Test`() {
        ...
        assertEquals("2012-06-13", obj.date.toString())
    ...
    @Test
    fun `conceptmap-example 882 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-2 883 Test`() {
    ...
    @Test
    fun `conceptmap-example-specimen-type 884 Test`() {
        ...
        assertEquals("2013-07-25", obj.date.toString())
    ...
    @Test
    fun `conceptmap-example-specimen-type 885 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 886 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 887 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 888 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 889 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 890 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 891 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 892 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 893 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 894 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 895 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 896 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 897 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 898 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
    ...
    @Test
    fun `conceptmap-example-specimen-type 899 Test`() {
        val json = File("./src/test/resources/model/sample_data/conceptmap-example-specimen-type.json").readTextAndClose()
        val obj = mapper.fromJson(json, ConceptMap::class.java)
