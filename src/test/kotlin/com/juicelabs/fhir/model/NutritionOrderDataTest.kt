...
class NutritionOrderDataTest : DataTests() {
    @Test
    fun `nutritionorder-example-diabeticsupplement 342 Test`() {
        ...
        assertEquals("2014-09-17", obj.dateTime.toString())
    ...
    @Test
    fun `nutritionorder-example-diabeticsupplement 343 Test`() {
        val json = File("./src/test/resources/model/sample_data/nutritionorder-example-diabeticsupplement.json").readTextAndClose()
        val obj = mapper.fromJson(json, NutritionOrder::class.java)
        ...
        assertEquals("2015-02-10T15:00:00Z", obj.supplement[0].schedule[0].repeat!!.boundsPeriod!!.start.toString())
    ...
    @Test
    fun `nutritionorder-example-enteralbolus 344 Test`() {
        ...
        assertEquals("2014-09-17T16:00:00Z", obj.enteralFormula!!.administration[0].schedule!!.repeat!!.boundsPeriod!!.start.toString())
    ...
    fun `nutritionorder-example-fiberrestricteddiet 346 Test`() {
        ...
        assertEquals("2015-02-10", obj.oralDiet!!.schedule[0].repeat!!.boundsPeriod!!.start.toString())
    ...
    @Test
    fun `nutritionorder-example-texture-modified 347 Test`() {
    ...
    @Test
    fun `nutritionorder-example-texture-modified 348 Test`() {
        val json = File("./src/test/resources/model/sample_data/nutritionorder-example-texture-modified.json").readTextAndClose()
        val obj = mapper.fromJson(json, NutritionOrder::class.java)
    ...
    @Test
    fun `nutritionorder-example-pureeddiet-simple 349 Test`() {
    ...
    @Test
    fun `nutritionorder-example-infantenteral 350 Test`() {
    ...
    @Test
    fun `nutritionorder-example-infantenteral 351 Test`() {
        val json = File("./src/test/resources/model/sample_data/nutritionorder-example-infantenteral.json").readTextAndClose()
        val obj = mapper.fromJson(json, NutritionOrder::class.java)
        assertTrue(stringMatch("http://unitsofmeasure.org", obj.enteralFormula!!.caloricDensity!!.system))
        ...
        assertEquals("2014-09-17", obj.enteralFormula!!.administration[0].schedule!!.repeat!!.boundsPeriod!!.start.toString())
        assertEquals(1, obj.enteralFormula!!.administration[0].schedule!!.repeat!!.frequency)
    ...
    @Test
    fun `nutritionorder-example-enteralcontinuous 352 Test`() {
        ...
        assertEquals("2014-09-17T07:00:00Z", obj.enteralFormula!!.administration[0].schedule!!.repeat!!.boundsPeriod!!.start.toString())
        ...
        assertEquals("2014-09-17T11:00:00Z", obj.enteralFormula!!.administration[1].schedule!!.repeat!!.boundsPeriod!!.start.toString())
        ...
        assertEquals("2014-09-17T15:00:00Z", obj.enteralFormula!!.administration[2].schedule!!.repeat!!.boundsPeriod!!.start.toString())
    ...
    @Test
    fun `nutritionorder-example-cardiacdiet 353 Test`() {
    ...
    @Test
    fun `nutritionorder-example-cardiacdiet 354 Test`() {
        val json = File("./src/test/resources/model/sample_data/nutritionorder-example-cardiacdiet.json").readTextAndClose()
        val obj = mapper.fromJson(json, NutritionOrder::class.java)
        assertTrue(stringMatch("Patient/example", obj.patient.reference))
        assertTrue(stringMatch("Peter Chalmers", obj.patient.display))
    ...
    @Test
    fun `nutritionorder-example-pureeddiet 355 Test`() {
    ...
    @Test
    fun `nutritionorder-example-pureeddiet 356 Test`() {
        val json = File("./src/test/resources/model/sample_data/nutritionorder-example-pureeddiet.json").readTextAndClose()
        val obj = mapper.fromJson(json, NutritionOrder::class.java)
        assertTrue(stringMatch("Pureed diet", obj.oralDiet!!.type[0].coding[1].display))
        assertTrue(stringMatch("Pureed diet", obj.oralDiet!!.type[0].text))
    ...
    @Test
    fun `nutritionorder-example-diabeticdiet 357 Test`() {
    ...
    @Test
    fun `nutritionorder-example-proteinsupplement 358 Test`() {
    ...
    @Test
    fun `nutritionorder-example-proteinsupplement 359 Test`() {
        val json = File("./src/test/resources/model/sample_data/nutritionorder-example-proteinsupplement.json").readTextAndClose()
        val obj = mapper.fromJson(json, NutritionOrder::class.java)
        assertTrue(stringMatch("http://goodhealthhospital.org", obj.supplement[0].type!!.coding[1].system))
        ...
        assertEquals("2015-02-10", obj.supplement[0].schedule[0].repeat!!.boundsPeriod!!.start.toString())
    ...
    @Test
    fun `nutritionorder-example-renaldiet 360 Test`() {
    ...
    @Test
    fun `nutritionorder-example-energysupplement 361 Test`() {
    ...
    @Test
    fun `nutritionorder-example-energysupplement 362 Test`() {
        val json = File("./src/test/resources/model/sample_data/nutritionorder-example-energysupplement.json").readTextAndClose()
        val obj = mapper.fromJson(json, NutritionOrder::class.java)
        assertTrue(stringMatch("123", obj.identifier[0].value))
        assertTrue(stringMatch("active", obj.status))
