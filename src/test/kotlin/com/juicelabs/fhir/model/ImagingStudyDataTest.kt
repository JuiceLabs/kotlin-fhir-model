...
class ImagingStudyDataTest : DataTests() {
    @Test
    fun `imagingstudy-example-xr 749 Test`() {
        ...
        assertEquals("2017-01-01T11:01:20+03:00", obj.started.toString())
    ...
    @Test
    fun `imagingstudy-example-xr 750 Test`() {
        val json = File("./src/test/resources/model/sample_data/imagingstudy-example-xr.json").readTextAndClose()
        val obj = mapper.fromJson(json, ImagingStudy::class.java)
        ...
        assertEquals("2011-01-01T11:01:20+03:00", obj.series[0].started.toString())
    ...
    @Test
    fun `imagingstudy-example 751 Test`() {
        ...
        assertTrue(stringMatch("urn:oid:2.16.124.113543.6003.", obj.uid))
        assertTrue(stringMatch("Patient/dicom", obj.patient.reference))
        assertEquals("2011-01-01T11:01:20+03:00", obj.started.toString())
        assertEquals(1, obj.numberOfSeries)
