...
class MediaDataTest : DataTests() {
    @Test
    fun `media-example 268 Test`() {
        val json = File("./src/test/resources/model/sample_data/media-example.json").readTextAndClose()
        ...
        assertEquals("2009-09-03", obj.content.creation.toString())
    }

    @Test
    fun `media-example-dicom 269 Test`() {
        val json = File("./src/test/resources/model/sample_data/media-example-dicom.json").readTextAndClose()
        val obj = mapper.fromJson(json, Media::class.java)
        assertTrue(stringMatch("Media", obj.resourceType))
    ...
    @Test
    fun `media-example-dicom 270 Test`() {
        val json = File("./src/test/resources/model/sample_data/media-example-dicom.json").readTextAndClose()
        val obj = mapper.fromJson(json, Media::class.java)
    ...
    @Test
    fun `media-example-xray 271 Test`() {
        val json = File("./src/test/resources/model/sample_data/media-example-xray.json").readTextAndClose()
        val obj = mapper.fromJson(json, Media::class.java)
        assertTrue(stringMatch("Media", obj.resourceType))
        ...
        assertEquals("2016-03-15", obj.occurrenceDateTime.toString())
        ...
        assertEquals("2016-03-15", obj.content.creation.toString())
    }

    @Test
    fun `media-example-sound 272 Test`() {
        val json = File("./src/test/resources/model/sample_data/media-example-sound.json").readTextAndClose()
        val obj = mapper.fromJson(json, Media::class.java)
        assertTrue(stringMatch("Media", obj.resourceType))
