...
class AdverseEventDataTest : DataTests() {
    @Test
    fun `adverseevent-example 997 Test`() {
        val json = File("./src/test/resources/model/sample_data/adverseevent-example.json").readTextAndClose()
        ...
        assertEquals("2017-01-29T12:34:56+00:00", obj.date.toString())
