...
class ServiceDefinitionDataTest : DataTests() {
    @Test
    fun `servicedefinition-example 976 Test`() {
        val json = File("./src/test/resources/model/sample_data/servicedefinition-example.json").readTextAndClose()
        ...
        assertEquals("2015-07-22", obj.date.toString())
