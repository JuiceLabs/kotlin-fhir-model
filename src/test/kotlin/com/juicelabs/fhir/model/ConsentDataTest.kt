...
class ConsentDataTest : DataTests() {
    @Test
    fun `consent-example-notThis 165 Test`() {
        ...
        assertEquals("2015-11-18", obj.dateTime.toString())
    ...
    @Test
    fun `consent-example-smartonfhir 166 Test`() {
        ...
        assertEquals("2016-06-23T17:02:33+10:00", obj.period!!.start.toString())
        assertEquals("2016-06-23T17:32:33+10:00", obj.period!!.end.toString())
        assertEquals("2016-06-23T17:02:33+10:00", obj.dateTime.toString())
    ...
    @Test
    fun `consent-example-notAuthor 167 Test`() {
    ...
    fun `consent-example-notTime 169 Test`() {
        ...
        assertTrue(stringMatch("http://hl7.org/fhir/ConsentPo", obj.policyRule))
        assertTrue(stringMatch("deny", obj.except[0].type))
        assertEquals("2015-01-01", obj.except[0].period!!.start.toString())
        assertEquals("2015-02-01", obj.except[0].period!!.end.toString())
    }

    @Test
    fun `consent-example-signature 170 Test`() {
        ...
        assertEquals("2015-10-10", obj.period!!.start.toString())
        assertEquals("2016-10-10", obj.period!!.end.toString())
        assertEquals("2016-05-26T00:41:10-04:00", obj.dateTime.toString())
    ...
    @Test
    fun `consent-example-notThem 171 Test`() {
    ...
    @Test
    fun `consent-example-grantor 172 Test`() {
    ...
    @Test
    fun `consent-example-grantor 173 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-grantor.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
        assertTrue(stringMatch("P. van de Heuvel", obj.patient.display))
        assertEquals("2015-11-18", obj.dateTime.toString())
    ...
    @Test
    fun `consent-example-notOrg 174 Test`() {
    ...
    @Test
    fun `consent-example-pkb 175 Test`() {
        ...
        assertEquals("2016-06-16", obj.dateTime.toString())
    ...
    @Test
    fun `consent-example-pkb 176 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-pkb.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
    ...
    @Test
    fun `consent-example-pkb 177 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-pkb.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
    ...
    fun `consent-example 178 Test`() {
        ...
        assertTrue(stringMatch("Patient/f001", obj.patient.reference))
        assertTrue(stringMatch("P. van de Heuvel", obj.patient.display))
        assertEquals("1964-01-01", obj.period!!.start.toString())
        assertEquals("2016-01-01", obj.period!!.end.toString())
        assertEquals("2016-05-11", obj.dateTime.toString())
        assertTrue(stringMatch("Organization/Infoway", obj.organization[0].reference))
        assertTrue(stringMatch("Canada Infoway", obj.organization[0].display))
        assertTrue(stringMatch("The terms of the consent in l", obj.sourceAttachment!!.title))
    ...
    @Test
    fun `consent-example-Emergency 179 Test`() {
    ...
    @Test
    fun `consent-example-Out 180 Test`() {
