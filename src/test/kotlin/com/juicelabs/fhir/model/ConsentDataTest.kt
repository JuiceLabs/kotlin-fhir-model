...
class ConsentDataTest : DataTests() {
    ...
    fun `consent-example-notThis 120 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-notThis.json").readTextAndClose()
    ...
    fun `consent-example-smartonfhir 121 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-smartonfhir.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
        assertTrue(stringMatch("Consent", obj.resourceType))
    ...
    fun `consent-example-notAuthor 122 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-notAuthor.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
        assertTrue(stringMatch("Consent", obj.resourceType))
    ...
    fun `consent-example-notTime 123 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-notTime.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
        assertTrue(stringMatch("Consent", obj.resourceType))
    ...
    fun `consent-example-signature 124 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-signature.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
        assertTrue(stringMatch("Consent", obj.resourceType))
    ...
    fun `consent-example-notThem 125 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-notThem.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
        assertTrue(stringMatch("Consent", obj.resourceType))
    ...
    fun `consent-example-grantor 126 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-grantor.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
        assertTrue(stringMatch("Consent", obj.resourceType))
    ...
    fun `consent-example-notOrg 127 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-notOrg.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
        assertTrue(stringMatch("Consent", obj.resourceType))
    ...
    fun `consent-example-pkb 128 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-pkb.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
        assertTrue(stringMatch("Consent", obj.resourceType))
    ...
    fun `consent-example 129 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
        assertTrue(stringMatch("Consent", obj.resourceType))
    ...
    fun `consent-example-Emergency 130 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-Emergency.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
        assertTrue(stringMatch("Consent", obj.resourceType))
    ...
    fun `consent-example-Out 132 Test`() {
        val json = File("./src/test/resources/model/sample_data/consent-example-Out.json").readTextAndClose()
        val obj = mapper.fromJson(json, Consent::class.java)
        assertTrue(stringMatch("Consent", obj.resourceType))
