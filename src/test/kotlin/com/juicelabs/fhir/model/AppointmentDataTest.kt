...
class AppointmentDataTest : DataTests() {
    ...
    fun `appointment-example 357 Test`() {
        val json = File("./src/test/resources/model/sample_data/appointment-example.json").readTextAndClose()
    ...
    fun `appointment-example-request 358 Test`() {
        val json = File("./src/test/resources/model/sample_data/appointment-example-request.json").readTextAndClose()
        val obj = mapper.fromJson(json, Appointment::class.java)
        assertTrue(stringMatch("Appointment", obj.resourceType))
    ...
    fun `appointment-example2doctors 359 Test`() {
        val json = File("./src/test/resources/model/sample_data/appointment-example2doctors.json").readTextAndClose()
        val obj = mapper.fromJson(json, Appointment::class.java)
        assertTrue(stringMatch("Appointment", obj.resourceType))
