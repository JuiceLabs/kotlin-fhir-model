...
class AppointmentDataTest : DataTests() {
    @Test
    fun `appointment-example 677 Test`() {
        ...
        assertEquals("2013-12-10T09:00:00Z", obj.start.toString())
        assertEquals("2013-12-10T11:00:00Z", obj.end.toString())
        assertEquals("2013-10-10", obj.created.toString())
    ...
    @Test
    fun `appointment-example-request 678 Test`() {
    ...
    @Test
    fun `appointment-example-request 679 Test`() {
        val json = File("./src/test/resources/model/sample_data/appointment-example-request.json").readTextAndClose()
        val obj = mapper.fromJson(json, Appointment::class.java)
        assertTrue(stringMatch("General Practice", obj.specialty[0].coding[0].display))
        assertTrue(stringMatch("http://example.org/appointmen", obj.appointmentType!!.coding[0].system))
        ...
        assertEquals("2015-12-02", obj.created.toString())
        assertTrue(stringMatch("Further expand on the results", obj.comment))
        assertTrue(stringMatch("Patient/example", obj.participant[0].actor!!.reference))
        assertTrue(stringMatch("Peter James Chalmers", obj.participant[0].actor!!.display))
        assertTrue(stringMatch("required", obj.participant[0].required))
        ...
        assertTrue(stringMatch("required", obj.participant[2].required))
        assertTrue(stringMatch("accepted", obj.participant[2].status))
        assertEquals("2016-06-02", obj.requestedPeriod[0].start.toString())
        assertEquals("2016-06-09", obj.requestedPeriod[0].end.toString())
    }

    @Test
    fun `appointment-example2doctors 680 Test`() {
        ...
        assertEquals("2013-12-09T09:00:00Z", obj.start.toString())
        assertEquals("2013-12-09T11:00:00Z", obj.end.toString())
