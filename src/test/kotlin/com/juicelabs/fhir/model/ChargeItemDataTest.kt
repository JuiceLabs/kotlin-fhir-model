...
class ChargeItemDataTest : DataTests() {
    @Test
    fun `chargeitem-example 977 Test`() {
        val json = File("./src/test/resources/model/sample_data/chargeitem-example.json").readTextAndClose()
        ...
        assertEquals("2017-01-25T08:00:00+01:00", obj.occurrencePeriod!!.start.toString())
        assertEquals("2017-01-25T12:35:00+01:00", obj.occurrencePeriod!!.end.toString())
    ...
    @Test
    fun `chargeitem-example 978 Test`() {
        val json = File("./src/test/resources/model/sample_data/chargeitem-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, ChargeItem::class.java)
        ...
        assertEquals("2017-01-25T23:55:04+01:00", obj.enteredDate.toString())
        ...
        assertEquals("2017-01-25T23:55:04+01:00", obj.note[0].time.toString())
