...
class CommunicationRequestDataTest : DataTests() {
    @Test
    fun `communicationrequest-example 827 Test`() {
        val json = File("./src/test/resources/model/sample_data/communicationrequest-example.json").readTextAndClose()
    ...
    @Test
    fun `communicationrequest-example-fm-solicit-attachment 828 Test`() {
        val json = File("./src/test/resources/model/sample_data/communicationrequest-example-fm-solicit-attachment.json").readTextAndClose()
        val obj = mapper.fromJson(json, CommunicationRequest::class.java)
        assertTrue(stringMatch("CommunicationRequest", obj.resourceType))
        ...
        assertEquals("2016-06-10T11:01:10-08:00", obj.occurrenceDateTime.toString())
        assertEquals("2016-06-10T11:01:10-08:00", obj.authoredOn.toString())
