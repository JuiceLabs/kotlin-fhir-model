...
class SequenceDataTest : DataTests() {
    @Test
    fun `sequence-graphic-example-1 850 Test`() {
    ...
    @Test
    fun `sequence-graphic-example-1 851 Test`() {
        val json = File("./src/test/resources/model/sample_data/sequence-graphic-example-1.json").readTextAndClose()
        val obj = mapper.fromJson(json, Sequence::class.java)
    ...
    @Test
    fun `sequence-example-fda-vcfeval 852 Test`() {
    ...
    @Test
    fun `sequence-example-TPMT-one 853 Test`() {
    ...
    @Test
    fun `sequence-example-pgx-2 854 Test`() {
    ...
    @Test
    fun `sequence-example-pgx-2 855 Test`() {
        val json = File("./src/test/resources/model/sample_data/sequence-example-pgx-2.json").readTextAndClose()
        val obj = mapper.fromJson(json, Sequence::class.java)
        assertTrue(stringMatch("dna", obj.type))
        assertEquals(0, obj.coordinateSystem)
    ...
    @Test
    fun `sequence-example-fda 857 Test`() {
    ...
    @Test
    fun `coord-1base-example 858 Test`() {
    ...
    @Test
    fun `coord-1base-example 859 Test`() {
        val json = File("./src/test/resources/model/sample_data/coord-1base-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Sequence::class.java)
    ...
    @Test
    fun `sequence-graphic-example-4 860 Test`() {
    ...
    @Test
    fun `sequence-graphic-example-5 861 Test`() {
    ...
    @Test
    fun `sequence-example-TPMT-two 862 Test`() {
    ...
    @Test
    fun `sequence-example-pgx-1 863 Test`() {
    ...
    @Test
    fun `sequence-example-pgx-1 864 Test`() {
        val json = File("./src/test/resources/model/sample_data/sequence-example-pgx-1.json").readTextAndClose()
        val obj = mapper.fromJson(json, Sequence::class.java)
        assertEquals(0, obj.coordinateSystem)
        assertTrue(stringMatch("Patient/example", obj.patient!!.reference))
    ...
    @Test
    fun `sequence-example-fda-comparisons 865 Test`() {
    ...
    @Test
    fun `coord-0base-example 866 Test`() {
    ...
    @Test
    fun `coord-0base-example 867 Test`() {
        val json = File("./src/test/resources/model/sample_data/coord-0base-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Sequence::class.java)
        assertTrue(stringMatch("ACATGGTAGC", obj.observedSeq))
    }
    ...
    @Test
    fun `sequence-graphic-example-2 868 Test`() {
    ...
    @Test
    fun `sequence-graphic-example-3 869 Test`() {
