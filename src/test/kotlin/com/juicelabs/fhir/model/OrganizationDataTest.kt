...
class OrganizationDataTest : DataTests() {
    @Test
    fun `organization-example 660 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example.json").readTextAndClose()
    ...
    @Test
    fun `organization-example 661 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
    ...
    @Test
    fun `organization-example-mmanu 662 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example-mmanu.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
        assertTrue(stringMatch("Organization", obj.resourceType))
    ...
    @Test
    fun `organization-example-gastro 663 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example-gastro.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
        assertTrue(stringMatch("Organization", obj.resourceType))
    ...
    @Test
    fun `organization-example-lab 664 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example-lab.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
        assertTrue(stringMatch("Organization", obj.resourceType))
    ...
    @Test
    fun `organization-example-f002-burgers-card 665 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example-f002-burgers-card.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
        assertTrue(stringMatch("Organization", obj.resourceType))
    ...
    @Test
    fun `organization-example-f201-aumc 666 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example-f201-aumc.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
        assertTrue(stringMatch("Organization", obj.resourceType))
    ...
    @Test
    fun `organization-example-f201-aumc 667 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example-f201-aumc.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
    ...
    @Test
    fun `organization-example-good-health-care 668 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example-good-health-care.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
        assertTrue(stringMatch("Organization", obj.resourceType))
    ...
    @Test
    fun `organization-example-f001-burgers 669 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example-f001-burgers.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
        assertTrue(stringMatch("Organization", obj.resourceType))
    ...
    @Test
    fun `organization-example-f001-burgers 670 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example-f001-burgers.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
    ...
    @Test
    fun `organization-example-insurer 671 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example-insurer.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
        assertTrue(stringMatch("Organization", obj.resourceType))
    ...
    @Test
    fun `organization-example-f203-bumc 672 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example-f203-bumc.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
        assertTrue(stringMatch("Organization", obj.resourceType))
    ...
    @Test
    fun `organization-example-f003-burgers-ENT 673 Test`() {
        val json = File("./src/test/resources/model/sample_data/organization-example-f003-burgers-ENT.json").readTextAndClose()
        val obj = mapper.fromJson(json, Organization::class.java)
        assertTrue(stringMatch("Organization", obj.resourceType))
