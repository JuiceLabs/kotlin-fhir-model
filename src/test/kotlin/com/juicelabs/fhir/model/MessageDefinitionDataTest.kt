...
class MessageDefinitionDataTest : DataTests() {
    @Test
    fun `messagedefinition-example 927 Test`() {
        val json = File("./src/test/resources/model/sample_data/messagedefinition-example.json").readTextAndClose()
        ...
        assertEquals("2016-11-09", obj.date.toString())
