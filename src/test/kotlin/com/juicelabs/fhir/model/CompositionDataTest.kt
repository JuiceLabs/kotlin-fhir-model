...
class CompositionDataTest : DataTests() {
    @Test
    fun `composition-example 1005 Test`() {
        val json = File("./src/test/resources/model/sample_data/composition-example.json").readTextAndClose()
        ...
        assertEquals("2012-01-04T09:10:14Z", obj.date.toString())
        ...
        assertEquals("2012-01-04T09:10:14Z", obj.attester[0].time.toString())
        ...
        assertEquals("2010-07-18", obj.event[0].period!!.start.toString())
        assertEquals("2012-11-12", obj.event[0].period!!.end.toString())
    ...
    @Test
    fun `composition-example 1006 Test`() {
        val json = File("./src/test/resources/model/sample_data/composition-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Composition::class.java)
