...
class ProcedureRequestDataTest : DataTests() {
    ...
    fun `procedurerequest-example-lipid 58 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-lipid.json").readTextAndClose()
    ...
    fun `procedurerequest-example-lipid Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example4 59 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example4.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example4 Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example-edu 60 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-edu.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example-edu Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example-pt 61 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-pt.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example-pt Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-genetics-example-1 62 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-genetics-example-1.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-genetics-example-1 Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example-di 63 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-di.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example-di Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example-subrequest 64 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-subrequest.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example-subrequest Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example2 65 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example2.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example2 Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example3 66 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example3.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example3 Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example-ambulation 67 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-ambulation.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example-ambulation Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example-implant 69 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-implant.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example-implant Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example-colonoscopy 70 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-colonoscopy.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example-colonoscopy Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example-colonoscopy-bx 71 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-colonoscopy-bx.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example-colonoscopy-bx Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example-appendectomy 72 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-appendectomy.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example-appendectomy Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example 73 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example-ft4 74 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-ft4.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example-ft4 Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example-ob 75 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-ob.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example-ob Init`(obj: Bundle) {
    }

    @Test
    fun `procedurerequest-example-pgx 76 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-pgx.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("ProcedureRequest", obj.resourceType))
    ...
    fun `procedurerequest-example-pgx Init`(obj: Bundle) {
    }
}
