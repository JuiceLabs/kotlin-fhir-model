...
class ProcedureRequestDataTest : DataTests() {
    @Test
    fun `procedurerequest-example-lipid 85 Test`() {
    ...
    @Test
    fun `procedurerequest-example-lipid 86 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-lipid.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        ...
        assertEquals("2013-05-02T16:16:00-07:00", obj.occurrenceDateTime.toString())
    ...
    @Test
    fun `procedurerequest-example4 87 Test`() {
    ...
    @Test
    fun `procedurerequest-example-edu 88 Test`() {
        ...
        assertEquals("2014-08-16", obj.occurrenceDateTime.toString())
        assertEquals("2016-08-16", obj.authoredOn.toString())
    ...
    @Test
    fun `procedurerequest-example-pt 89 Test`() {
    ...
    @Test
    fun `procedurerequest-example-pt 90 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-pt.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertEquals("2016-09-27", obj.occurrenceDateTime.toString())
        assertEquals("2016-09-20", obj.authoredOn.toString())
    ...
    @Test
    fun `procedurerequest-genetics-example-1 91 Test`() {
        ...
        assertTrue(stringMatch("Patient/example", obj.subject.reference))
        assertTrue(stringMatch("Encounter/example", obj.context!!.reference))
        assertEquals("2014-05-12T16:16:00-07:00", obj.occurrenceDateTime.toString())
        assertTrue(stringMatch("Practitioner/example", obj.requester!!.agent.reference))
        assertTrue(stringMatch("Practitioner/example", obj.performer!!.reference))
    }

    @Test
    fun `procedurerequest-example-di 92 Test`() {
    ...
    @Test
    fun `procedurerequest-example-subrequest 93 Test`() {
    ...
    @Test
    fun `procedurerequest-example2 94 Test`() {
        ...
        assertEquals("2017-02-01T17:23:07Z", (obj.contained[0] as Provenance).recorded.toString())
    ...
    @Test
    fun `procedurerequest-example2 95 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example2.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        ...
        assertEquals("2017-02-01T17:23:07Z", (obj.contained[0] as Provenance).signature[0].when_fhir.toString())
        ...
        assertEquals("2012-11-12", (obj.contained[1] as Condition).onsetDateTime.toString())
        assertTrue(stringMatch("http://hl7.org/fhir/identifie", obj.identifier[0].type!!.coding[0].system))
        assertTrue(stringMatch("PLAC", obj.identifier[0].type!!.coding[0].code))
        ...
        assertEquals("2017-02-01T17:23:07Z", obj.authoredOn.toString())
        assertTrue(stringMatch("Practitioner/example", obj.requester!!.agent.reference))
        assertTrue(stringMatch("Dr Adam Careful", obj.requester!!.agent.display))
    ...
    @Test
    fun `procedurerequest-example3 96 Test`() {
    ...
    @Test
    fun `procedurerequest-example3 97 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example3.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("Dr Adam Careful", obj.requester!!.agent.display))
    ...
    @Test
    fun `procedurerequest-example-ambulation 98 Test`() {
        ...
        assertTrue(stringMatch("Patient/example", obj.subject.reference))
        assertEquals("2017-03-05", obj.authoredOn.toString())
    ...
    @Test
    fun `procedurerequest-example-implant 99 Test`() {
        ...
        assertTrue(stringMatch("Patient/example", obj.subject.reference))
        assertEquals("2015-03-30", obj.authoredOn.toString())
        assertTrue(stringMatch("Practitioner/3ad0687e-f477-46", obj.requester!!.agent.reference))
        assertTrue(stringMatch("Dr. Beverly Crusher", obj.requester!!.agent.display))
        assertTrue(stringMatch("Practitioner/example", obj.performer!!.reference))
    ...
    @Test
    fun `procedurerequest-example-colonoscopy 100 Test`() {
    ...
    @Test
    fun `procedurerequest-example-colonoscopy-bx 101 Test`() {
    ...
    @Test
    fun `procedurerequest-example-colonoscopy-bx 102 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-colonoscopy-bx.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
        assertTrue(stringMatch("Patient/example", obj.subject.reference))
        assertEquals("2017-03-05", obj.authoredOn.toString())
    ...
    @Test
    fun `procedurerequest-example-appendectomy 103 Test`() {
    ...
    @Test
    fun `procedurerequest-example 104 Test`() {
    ...
    @Test
    fun `procedurerequest-example-ft4 105 Test`() {
        ...
        assertEquals("2015-08-27T09:33:27+07:00", obj.occurrenceDateTime.toString())
        assertTrue(stringMatch("Practitioner/example", obj.requester!!.agent.reference))
    }

    @Test
    fun `procedurerequest-example-ob 106 Test`() {
        ...
        assertTrue(stringMatch("Jane Doe", obj.subject.display))
        assertEquals("2012-06-02", obj.occurrenceDateTime.toString())
    ...
    @Test
    fun `procedurerequest-example-pgx 107 Test`() {
        ...
        assertEquals("2016-10-10T15:00:00-07:00", obj.authoredOn.toString())
    }

    @Test
    fun `procedurerequest-example-pgx 108 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedurerequest-example-pgx.json").readTextAndClose()
        val obj = mapper.fromJson(json, ProcedureRequest::class.java)
