...
class MedicationAdministrationDataTest : DataTests() {
    @Test
    fun `medicationadministrationexample3 689 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationadministrationexample3.json").readTextAndClose()
        ...
        assertEquals("2015-01-15T14:30:00+01:00", obj.effectivePeriod.start.toString())
        assertEquals("2015-01-15T14:30:00+01:00", obj.effectivePeriod.end.toString())
