...
class DocumentManifestDataTest : DataTests() {
    @Test
    fun `documentmanifest-example 697 Test`() {
        val json = File("./src/test/resources/model/sample_data/documentmanifest-example.json").readTextAndClose()
        ...
        assertEquals("2004-12-25T23:50:50-05:00", obj.created.toString())
