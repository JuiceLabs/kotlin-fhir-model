...
class RequestGroupDataTest : DataTests() {
    @Test
    fun `requestgroup-kdn5-example 969 Test`() {
        ...
        assertEquals("2017-03-06T17:31:00Z", obj.authoredOn.toString())
    ...
    @Test
    fun `requestgroup-kdn5-example 970 Test`() {
        val json = File("./src/test/resources/model/sample_data/requestgroup-kdn5-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, RequestGroup::class.java)
    ...
    @Test
    fun `requestgroup-example 971 Test`() {
        ...
        assertEquals("2017-03-06T19:00:00Z", obj.action[0].timingDateTime.toString())
    ...
    @Test
    fun `requestgroup-example 972 Test`() {
        val json = File("./src/test/resources/model/sample_data/requestgroup-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, RequestGroup::class.java)
