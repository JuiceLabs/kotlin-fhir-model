...
class SpecimenDataTest : DataTests() {
    ...
    fun `specimen-example-isolate 444 Test`() {
        val json = File("./src/test/resources/model/sample_data/specimen-example-isolate.json").readTextAndClose()
    ...
    fun `specimen-example-urine 445 Test`() {
        val json = File("./src/test/resources/model/sample_data/specimen-example-urine.json").readTextAndClose()
        val obj = mapper.fromJson(json, Specimen::class.java)
        assertTrue(stringMatch("Specimen", obj.resourceType))
    ...
    fun `specimen-example-serum 446 Test`() {
        val json = File("./src/test/resources/model/sample_data/specimen-example-serum.json").readTextAndClose()
        val obj = mapper.fromJson(json, Specimen::class.java)
        assertTrue(stringMatch("Specimen", obj.resourceType))
    ...
    fun `specimen-example 447 Test`() {
        val json = File("./src/test/resources/model/sample_data/specimen-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Specimen::class.java)
        assertTrue(stringMatch("Specimen", obj.resourceType))
