...
class SpecimenDataTest : DataTests() {
    @Test
    fun `specimen-example-isolate 791 Test`() {
        ...
        assertEquals("2015-08-16T07:03:00Z", (obj.contained[0] as Specimen).receivedTime.toString())
        assertTrue(stringMatch("Patient", (obj.contained[0] as Specimen).collection!!.collector!!.display))
        assertEquals("2011-08-16T06:15:00Z", (obj.contained[0] as Specimen).collection!!.collectedDateTime.toString())
        ...
        assertEquals("2015-08-18T07:03:00Z", obj.receivedTime.toString())
        ...
        assertEquals("2015-08-16T07:03:00Z", obj.collection!!.collectedDateTime.toString())
    ...
    @Test
    fun `specimen-example-urine 792 Test`() {
        ...
        assertEquals("2015-08-18T07:03:00Z", obj.receivedTime.toString())
        assertTrue(stringMatch("Practitioner/f202", obj.collection!!.collector!!.reference))
        assertEquals("2015-08-18T07:03:00Z", obj.collection!!.collectedDateTime.toString())
        ...
        assertEquals("2015-08-18T08:10:00Z", obj.processing[0].timeDateTime.toString())
    }

    @Test
    fun `specimen-example-urine 793 Test`() {
        val json = File("./src/test/resources/model/sample_data/specimen-example-urine.json").readTextAndClose()
        val obj = mapper.fromJson(json, Specimen::class.java)
    ...
    @Test
    fun `specimen-example-serum 794 Test`() {
        ...
        assertTrue(stringMatch("Practitioner/f202", obj.collection!!.collector!!.reference))
        assertEquals("2015-08-16T06:40:17Z", obj.collection!!.collectedDateTime.toString())
    ...
    fun `specimen-example 795 Test`() {
        ...
        assertEquals("2011-03-04T07:03:00Z", obj.receivedTime.toString())
        ...
        assertEquals("2011-05-30T06:15:00Z", obj.collection!!.collectedDateTime.toString())
