...
class CommunicationDataTest : DataTests() {
    @Test
    fun `communication-example-fm-attachment 875 Test`() {
        val json = File("./src/test/resources/model/sample_data/communication-example-fm-attachment.json").readTextAndClose()
    ...
    @Test
    fun `communication-example-fm-attachment 876 Test`() {
        val json = File("./src/test/resources/model/sample_data/communication-example-fm-attachment.json").readTextAndClose()
        val obj = mapper.fromJson(json, Communication::class.java)
        ...
        assertEquals("2016-06-12T18:01:10-08:00", obj.sent.toString())
        ...
        assertEquals("2010-02-01T11:50:23-05:00", obj.payload[0].contentAttachment.creation.toString())
        ...
        assertEquals("2010-02-01T10:57:34+01:00", obj.payload[1].contentAttachment.creation.toString())
    }

    @Test
    fun `communication-example-fm-solicited-attachment 877 Test`() {
        val json = File("./src/test/resources/model/sample_data/communication-example-fm-solicited-attachment.json").readTextAndClose()
        val obj = mapper.fromJson(json, Communication::class.java)
        assertTrue(stringMatch("Communication", obj.resourceType))
    ...
    @Test
    fun `communication-example 878 Test`() {
        val json = File("./src/test/resources/model/sample_data/communication-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Communication::class.java)
        assertTrue(stringMatch("Communication", obj.resourceType))
    ...
    @Test
    fun `communication-example 879 Test`() {
        val json = File("./src/test/resources/model/sample_data/communication-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Communication::class.java)
        ...
        assertEquals("2014-12-12T18:01:10-08:00", obj.sent.toString())
        assertEquals("2014-12-12T18:01:11-08:00", obj.received.toString())
