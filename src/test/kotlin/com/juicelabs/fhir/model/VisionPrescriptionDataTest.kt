...
class VisionPrescriptionDataTest : DataTests() {
    @Test
    fun `visionprescription-example-1 931 Test`() {
        val json = File("./src/test/resources/model/sample_data/visionprescription-example-1.json").readTextAndClose()
        ...
        assertEquals("2014-06-15", obj.dateWritten.toString())
    ...
    @Test
    fun `visionprescription-example 932 Test`() {
        val json = File("./src/test/resources/model/sample_data/visionprescription-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, VisionPrescription::class.java)
        assertTrue(stringMatch("VisionPrescription", obj.resourceType))
    ...
    @Test
    fun `visionprescription-example 933 Test`() {
        val json = File("./src/test/resources/model/sample_data/visionprescription-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, VisionPrescription::class.java)
        assertTrue(stringMatch("http://hl7.org/fhir/ex-vision", obj.dispense[0].product!!.coding[0].system))
