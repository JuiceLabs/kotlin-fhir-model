...
class ReferralRequestDataTest : DataTests() {
    @Test
    fun `referralrequest-example 796 Test`() {
        val json = File("./src/test/resources/model/sample_data/referralrequest-example.json").readTextAndClose()
    ...
    @Test
    fun `referralrequest-example 797 Test`() {
        val json = File("./src/test/resources/model/sample_data/referralrequest-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, ReferralRequest::class.java)
        ...
        assertEquals("2014-03-14", obj.occurrencePeriod!!.end.toString())
        assertEquals("2014-02-14", obj.authoredOn.toString())
