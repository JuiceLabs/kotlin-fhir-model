...
class EncounterDataTest : DataTests() {
    @Test
    fun `encounter-example-home 646 Test`() {
        ...
        assertEquals("2015-01-17T16:00:00+10:00", obj.participant[0].period!!.start.toString())
        assertEquals("2015-01-17T16:30:00+10:00", obj.participant[0].period!!.end.toString())
        ...
        assertEquals("2015-01-17T16:00:00+10:00", obj.period!!.start.toString())
        assertEquals("2015-01-17T16:30:00+10:00", obj.period!!.end.toString())
        ...
        assertEquals("2015-01-17T16:00:00+10:00", obj.location[0].period!!.start.toString())
        assertEquals("2015-01-17T16:30:00+10:00", obj.location[0].period!!.end.toString())
    }

    @Test
    fun `encounter-example-f201-20130404 647 Test`() {
    ...
    @Test
    fun `encounter-example-f003-abscess 648 Test`() {
    ...
    @Test
    fun `encounter-example-f003-abscess 649 Test`() {
        val json = File("./src/test/resources/model/sample_data/encounter-example-f003-abscess.json").readTextAndClose()
        val obj = mapper.fromJson(json, Encounter::class.java)
    ...
    @Test
    fun `encounter-example 650 Test`() {
    ...
    @Test
    fun `encounter-example-f002-lung 651 Test`() {
    ...
    @Test
    fun `encounter-example-f002-lung 652 Test`() {
        val json = File("./src/test/resources/model/sample_data/encounter-example-f002-lung.json").readTextAndClose()
        val obj = mapper.fromJson(json, Encounter::class.java)
    ...
    @Test
    fun `encounter-example-f203-20130311 653 Test`() {
        ...
        assertEquals("2013-03-08", obj.statusHistory[0].period.start.toString())
        assertTrue(stringMatch("http://hl7.org/fhir/v3/ActCod", obj.class_fhir!!.system))
        assertTrue(stringMatch("IMP", obj.class_fhir!!.code))
        assertTrue(stringMatch("inpatient encounter", obj.class_fhir!!.display))
        assertTrue(stringMatch("http://snomed.info/sct", obj.type[0].coding[0].system))
        ...
        assertEquals("2013-03-20", obj.period!!.end.toString())
    ...
    @Test
    fun `encounter-example-xcda 654 Test`() {
    ...
    @Test
    fun `encounter-example-xcda 655 Test`() {
        val json = File("./src/test/resources/model/sample_data/encounter-example-xcda.json").readTextAndClose()
        val obj = mapper.fromJson(json, Encounter::class.java)
    ...
    @Test
    fun `encounter-example-f202-20130128 656 Test`() {
    ...
    @Test
    fun `encounter-example-emerg 657 Test`() {
        ...
        assertTrue(stringMatch("in-progress", obj.status))
        assertTrue(stringMatch("arrived", obj.statusHistory[0].status))
        assertEquals("2017-02-01T07:15:00+10:00", obj.statusHistory[0].period.start.toString())
        assertEquals("2017-02-01T07:35:00+10:00", obj.statusHistory[0].period.end.toString())
        assertTrue(stringMatch("triaged", obj.statusHistory[1].status))
        assertEquals("2017-02-01T07:35:00+10:00", obj.statusHistory[1].period.start.toString())
        assertEquals("2017-02-01T08:45:00+10:00", obj.statusHistory[1].period.end.toString())
        assertTrue(stringMatch("in-progress", obj.statusHistory[2].status))
        assertEquals("2017-02-01T08:45:00+10:00", obj.statusHistory[2].period.start.toString())
        assertEquals("2017-02-01T12:15:00+10:00", obj.statusHistory[2].period.end.toString())
        assertTrue(stringMatch("onleave", obj.statusHistory[3].status))
        assertEquals("2017-02-01T12:15:00+10:00", obj.statusHistory[3].period.start.toString())
        assertEquals("2017-02-01T12:45:00+10:00", obj.statusHistory[3].period.end.toString())
        assertTrue(stringMatch("in-progress", obj.statusHistory[4].status))
        assertEquals("2017-02-01T12:45:00+10:00", obj.statusHistory[4].period.start.toString())
        assertTrue(stringMatch("http://hl7.org/fhir/v3/ActCod", obj.class_fhir!!.system))
        assertTrue(stringMatch("IMP", obj.class_fhir!!.code))
        assertTrue(stringMatch("inpatient encounter", obj.class_fhir!!.display))
        ...
        assertEquals("2017-02-01T07:15:00+10:00", obj.classHistory[0].period.start.toString())
        assertEquals("2017-02-01T09:27:00+10:00", obj.classHistory[0].period.end.toString())
        ...
        assertEquals("2017-02-01T09:27:00+10:00", obj.classHistory[1].period.start.toString())
        assertTrue(stringMatch("Patient/example", obj.subject!!.reference))
        assertEquals("2017-02-01T07:15:00+10:00", obj.period!!.start.toString())
    ...
    @Test
    fun `encounter-example-emerg 658 Test`() {
        val json = File("./src/test/resources/model/sample_data/encounter-example-emerg.json").readTextAndClose()
        val obj = mapper.fromJson(json, Encounter::class.java)
        assertTrue(stringMatch("active", obj.location[0].status))
        assertEquals("2017-02-01T07:15:00+10:00", obj.location[0].period!!.start.toString())
        assertEquals("2017-02-01T08:45:00+10:00", obj.location[0].period!!.end.toString())
        assertTrue(stringMatch("Emergency", obj.location[1].location.display))
        assertTrue(stringMatch("active", obj.location[1].status))
        assertEquals("2017-02-01T08:45:00+10:00", obj.location[1].period!!.start.toString())
        assertEquals("2017-02-01T09:27:00+10:00", obj.location[1].period!!.end.toString())
        ...
        assertEquals("2017-02-01T09:27:00+10:00", obj.location[2].period!!.start.toString())
        assertEquals("2017-02-01T12:15:00+10:00", obj.location[2].period!!.end.toString())
        ...
        assertEquals("2017-02-01T12:15:00+10:00", obj.location[3].period!!.start.toString())
        assertEquals("2017-02-01T12:45:00+10:00", obj.location[3].period!!.end.toString())
        ...
        assertEquals("2017-02-01T12:45:00+10:00", obj.location[4].period!!.start.toString())
    }

    @Test
    fun `encounter-example-f001-heart 659 Test`() {
