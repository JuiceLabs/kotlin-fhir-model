...
class BodySiteDataTest : DataTests() {
    @Test
    fun `bodysite-example-fetus 961 Test`() {
        val json = File("./src/test/resources/model/sample_data/bodysite-example-fetus.json").readTextAndClose()
    ...
    @Test
    fun `bodysite-example-tumor 962 Test`() {
        val json = File("./src/test/resources/model/sample_data/bodysite-example-tumor.json").readTextAndClose()
        val obj = mapper.fromJson(json, BodySite::class.java)
        assertTrue(stringMatch("BodySite", obj.resourceType))
    ...
    @Test
    fun `bodysite-example-tumor 963 Test`() {
        val json = File("./src/test/resources/model/sample_data/bodysite-example-tumor.json").readTextAndClose()
        val obj = mapper.fromJson(json, BodySite::class.java)
    ...
    @Test
    fun `bodysite-example-skin-patch 964 Test`() {
        val json = File("./src/test/resources/model/sample_data/bodysite-example-skin-patch.json").readTextAndClose()
        val obj = mapper.fromJson(json, BodySite::class.java)
        assertTrue(stringMatch("BodySite", obj.resourceType))
