...
class FamilyMemberHistoryDataTest : DataTests() {
    @Test
    fun `familymemberhistory-example 131 Test`() {
        val json = File("./src/test/resources/model/sample_data/familymemberhistory-example.json").readTextAndClose()
        ...
        assertEquals("2011-03-18", obj.date.toString())
    ...
    @Test
    fun `familymemberhistory-example-mother 132 Test`() {
        val json = File("./src/test/resources/model/sample_data/familymemberhistory-example-mother.json").readTextAndClose()
        val obj = mapper.fromJson(json, FamilyMemberHistory::class.java)
        assertTrue(stringMatch("FamilyMemberHistory", obj.resourceType))
