...
class MedicationRequestDataTest : DataTests() {
    @Test
    fun `medicationrequestexample1 948 Test`() {
        ...
        assertEquals("2015-01-15", obj.authoredOn.toString())
        ...
        assertEquals("2015-01-15", obj.dispenseRequest!!.validityPeriod!!.start.toString())
        assertEquals("2016-01-15", obj.dispenseRequest!!.validityPeriod!!.end.toString())
    ...
    @Test
    fun `medicationrequestexample2 949 Test`() {
    ...
    @Test
    fun `medicationrequestexample2 950 Test`() {
        val json = File("./src/test/resources/model/sample_data/medicationrequestexample2.json").readTextAndClose()
        val obj = mapper.fromJson(json, MedicationRequest::class.java)
        assertTrue(stringMatch("http://www.bmc.nl/portal/pres", obj.identifier[0].system))
        ...
        assertEquals("2015-03-01", obj.authoredOn.toString())
        assertTrue(stringMatch("Practitioner/f007", obj.requester!!.agent.reference))
        assertTrue(stringMatch("Patrick Pump", obj.requester!!.agent.display))
        assertTrue(stringMatch("Organization/f002", obj.requester!!.onBehalfOf!!.reference))
