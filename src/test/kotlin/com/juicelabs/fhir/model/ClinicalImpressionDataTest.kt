...
class ClinicalImpressionDataTest : DataTests() {
    @Test
    fun `clinicalimpression-example 829 Test`() {
        val json = File("./src/test/resources/model/sample_data/clinicalimpression-example.json").readTextAndClose()
        ...
        assertEquals("2014-12-06T20:00:00+11:00", obj.effectivePeriod!!.start.toString())
        assertEquals("2014-12-06T22:33:00+11:00", obj.effectivePeriod!!.end.toString())
        assertEquals("2014-12-06T22:33:00+11:00", obj.date.toString())
    ...
    @Test
    fun `clinicalimpression-example 830 Test`() {
        val json = File("./src/test/resources/model/sample_data/clinicalimpression-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, ClinicalImpression::class.java)
