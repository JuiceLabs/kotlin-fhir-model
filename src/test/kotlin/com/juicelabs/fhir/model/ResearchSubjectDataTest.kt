...
class ResearchSubjectDataTest : DataTests() {
    @Test
    fun `researchsubject-example 1001 Test`() {
        val json = File("./src/test/resources/model/sample_data/researchsubject-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, ResearchSubject::class.java)
    }

    @Test
    fun `researchsubject-example 1002 Test`() {
        val json = File("./src/test/resources/model/sample_data/researchsubject-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, ResearchSubject::class.java)
