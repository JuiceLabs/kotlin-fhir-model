...
class CompartmentDefinitionDataTest : DataTests() {
    @Test
    fun `compartmentdefinition-example 181 Test`() {
        val json = File("./src/test/resources/model/sample_data/compartmentdefinition-example.json").readTextAndClose()
    ...
    @Test
    fun `compartmentdefinition-example 182 Test`() {
        val json = File("./src/test/resources/model/sample_data/compartmentdefinition-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, CompartmentDefinition::class.java)
        ...
        assertEquals("2017-02-24", obj.date.toString())
