...
class ExpansionProfileDataTest : DataTests() {
    @Test
    fun `expansionprofile-example 779 Test`() {
        val json = File("./src/test/resources/model/sample_data/expansionprofile-example.json").readTextAndClose()
        ...
        assertEquals("2016-12-23", obj.date.toString())
