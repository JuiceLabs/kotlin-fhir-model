...
class ProvenanceDataTest : DataTests() {
    @Test
    fun `provenance-example-sig 785 Test`() {
        val json = File("./src/test/resources/model/sample_data/provenance-example-sig.json").readTextAndClose()
        ...
        assertEquals("2015-08-27T08:39:24+10:00", obj.recorded.toString())
        ...
        assertEquals("2015-08-27T08:39:24+10:00", obj.signature[0].when_fhir.toString())
    ...
    @Test
    fun `provenance-example-cwl 786 Test`() {
        val json = File("./src/test/resources/model/sample_data/provenance-example-cwl.json").readTextAndClose()
        val obj = mapper.fromJson(json, Provenance::class.java)
        assertTrue(stringMatch("Provenance", obj.resourceType))
        ...
        assertEquals("2016-11-30", obj.period!!.start.toString())
        assertEquals("2016-12-01T08:12:14+10:00", obj.recorded.toString())
    ...
    @Test
    fun `provenance-example-biocompute-object 787 Test`() {
        val json = File("./src/test/resources/model/sample_data/provenance-example-biocompute-object.json").readTextAndClose()
        val obj = mapper.fromJson(json, Provenance::class.java)
        assertTrue(stringMatch("Provenance", obj.resourceType))
        ...
        assertEquals("2017-06-06", obj.period!!.start.toString())
        assertEquals("2016-06-09T08:12:14+10:00", obj.recorded.toString())
    ...
    @Test
    fun `provenance-example 788 Test`() {
        val json = File("./src/test/resources/model/sample_data/provenance-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Provenance::class.java)
        assertTrue(stringMatch("Provenance", obj.resourceType))
        ...
        assertEquals("2015-06-27", obj.period!!.start.toString())
        assertEquals("2015-06-28", obj.period!!.end.toString())
        assertEquals("2015-06-27T08:39:24+10:00", obj.recorded.toString())
    ...
    @Test
    fun `provenance-example 789 Test`() {
        val json = File("./src/test/resources/model/sample_data/provenance-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Provenance::class.java)
