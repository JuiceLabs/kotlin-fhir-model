...
class ProcedureDataTest : DataTests() {
    @Test
    fun `procedure-example-f201-tpf 609 Test`() {
        ...
        assertEquals("2013-01-28T13:31:00+01:00", obj.performedPeriod!!.start.toString())
        assertEquals("2013-01-28T14:27:00+01:00", obj.performedPeriod!!.end.toString())
    ...
    @Test
    fun `procedure-example-f201-tpf 610 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-f201-tpf.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
    ...
    @Test
    fun `procedure-example-ambulation 611 Test`() {
    ...
    @Test
    fun `procedure-example-implant 612 Test`() {
        ...
        assertTrue(stringMatch("Patient/example", obj.subject.reference))
        assertEquals("2015-04-05", obj.performedDateTime.toString())
    ...
    @Test
    fun `procedure-example-colon-biopsy 613 Test`() {
    ...
    @Test
    fun `procedure-example-f004-tracheotomy 614 Test`() {
    ...
    @Test
    fun `procedure-example-f004-tracheotomy 615 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-f004-tracheotomy.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("generated", obj.text!!.status))
        assertTrue(stringMatch("<div xmlns=\"http://www.w3.org", obj.text!!.div))
        ...
        assertEquals("2013-03-22T09:30:10+01:00", obj.performedPeriod!!.start.toString())
        assertEquals("2013-03-22T10:30:10+01:00", obj.performedPeriod!!.end.toString())
    ...
    @Test
    fun `procedure-example-education 616 Test`() {
        ...
        assertEquals("2014-08-16", obj.performedDateTime.toString())
    ...
    @Test
    fun `procedure-example-colonoscopy 617 Test`() {
    ...
    @Test
    fun `procedure-example-physical-therapy 618 Test`() {
    ...
    @Test
    fun `procedure-example-physical-therapy 619 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-physical-therapy.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        ...
        assertTrue(stringMatch("Patient/example", obj.subject.reference))
        assertEquals("2016-09-27", obj.performedDateTime.toString())
    ...
    @Test
    fun `procedure-example-f003-abscess 620 Test`() {
        ...
        assertTrue(stringMatch("P. van de Heuvel", obj.subject.display))
        assertTrue(stringMatch("Encounter/f003", obj.context!!.reference))
        assertEquals("2013-03-24T09:30:10+01:00", obj.performedPeriod!!.start.toString())
        assertEquals("2013-03-24T10:30:10+01:00", obj.performedPeriod!!.end.toString())
        assertTrue(stringMatch("urn:oid:2.16.840.1.113883.2.4", obj.performer[0].role!!.coding[0].system))
        assertTrue(stringMatch("01.000", obj.performer[0].role!!.coding[0].code))
        assertTrue(stringMatch("Arts", obj.performer[0].role!!.coding[0].display))
        assertTrue(stringMatch("Care role", obj.performer[0].role!!.text))
    ...
    @Test
    fun `procedure-example 621 Test`() {
        ...
        assertTrue(stringMatch("Patient/example", obj.subject.reference))
        assertEquals("2013-04-05", obj.performedDateTime.toString())
        assertTrue(stringMatch("Practitioner/example", obj.performer[0].actor.reference))
        assertTrue(stringMatch("Dr Cecil Surgeon", obj.performer[0].actor.display))
    ...
    @Test
    fun `procedure-example-appendectomy-narrative 622 Test`() {
    ...
    @Test
    fun `procedure-example-f001-heart 623 Test`() {
    ...
    @Test
    fun `procedure-example-f001-heart 624 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-f001-heart.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        ...
        assertEquals("2011-06-26", obj.performedPeriod!!.start.toString())
        assertEquals("2011-06-27", obj.performedPeriod!!.end.toString())
        assertTrue(stringMatch("urn:oid:2.16.840.1.113883.2.4", obj.performer[0].role!!.coding[0].system))
        assertTrue(stringMatch("01.000", obj.performer[0].role!!.coding[0].code))
        assertTrue(stringMatch("Arts", obj.performer[0].role!!.coding[0].display))
        assertTrue(stringMatch("Care role", obj.performer[0].role!!.text))
    ...
    @Test
    fun `procedure-example-f002-lung 625 Test`() {
        ...
        assertEquals("2013-03-08T09:00:10+01:00", obj.performedPeriod!!.start.toString())
        assertEquals("2013-03-08T09:30:10+01:00", obj.performedPeriod!!.end.toString())
        assertTrue(stringMatch("urn:oid:2.16.840.1.113883.2.4", obj.performer[0].role!!.coding[0].system))
        assertTrue(stringMatch("01.000", obj.performer[0].role!!.coding[0].code))
        assertTrue(stringMatch("Arts", obj.performer[0].role!!.coding[0].display))
        assertTrue(stringMatch("Care role", obj.performer[0].role!!.text))
    ...
    @Test
    fun `procedure-example-biopsy 626 Test`() {
        ...
        assertTrue(stringMatch("Patient/example", obj.subject.reference))
        assertEquals("2014-02-03", obj.performedDateTime.toString())
        assertTrue(stringMatch("Practitioner/example", obj.performer[0].actor.reference))
    ...
    @Test
    fun `procedure-example-biopsy 627 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-biopsy.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
    ...
    @Test
    fun `procedure-example-ob 628 Test`() {
        ...
        assertTrue(stringMatch("Jane Doe", obj.subject.display))
        assertEquals("2012-06-02", obj.performedDateTime.toString())
