...
class ProcedureDataTest : DataTests() {
    ...
    fun `procedure-example-f201-tpf 306 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-f201-tpf.json").readTextAndClose()
    ...
    fun `procedure-example-ambulation 307 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-ambulation.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example-implant 308 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-implant.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example-colon-biopsy 309 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-colon-biopsy.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example-f004-tracheotomy 310 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-f004-tracheotomy.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example-education 311 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-education.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example-colonoscopy 312 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-colonoscopy.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example-physical-therapy 313 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-physical-therapy.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example-f003-abscess 314 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-f003-abscess.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example 315 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example-appendectomy-narrative 316 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-appendectomy-narrative.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example-f001-heart 317 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-f001-heart.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example-f002-lung 318 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-f002-lung.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example-biopsy 319 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-biopsy.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
    ...
    fun `procedure-example-ob 320 Test`() {
        val json = File("./src/test/resources/model/sample_data/procedure-example-ob.json").readTextAndClose()
        val obj = mapper.fromJson(json, Procedure::class.java)
        assertTrue(stringMatch("Procedure", obj.resourceType))
