...
class LocationDataTest : DataTests() {
    @Test
    fun `location-example 835 Test`() {
        val json = File("./src/test/resources/model/sample_data/location-example.json").readTextAndClose()
    ...
    @Test
    fun `location-example-room 836 Test`() {
        val json = File("./src/test/resources/model/sample_data/location-example-room.json").readTextAndClose()
        val obj = mapper.fromJson(json, Location::class.java)
        assertTrue(stringMatch("Location", obj.resourceType))
    ...
    @Test
    fun `location-example-room 837 Test`() {
        val json = File("./src/test/resources/model/sample_data/location-example-room.json").readTextAndClose()
        val obj = mapper.fromJson(json, Location::class.java)
    ...
    @Test
    fun `location-example-ambulance 838 Test`() {
        val json = File("./src/test/resources/model/sample_data/location-example-ambulance.json").readTextAndClose()
        val obj = mapper.fromJson(json, Location::class.java)
        assertTrue(stringMatch("Location", obj.resourceType))
    ...
    @Test
    fun `location-example-ukpharmacy 839 Test`() {
        val json = File("./src/test/resources/model/sample_data/location-example-ukpharmacy.json").readTextAndClose()
        val obj = mapper.fromJson(json, Location::class.java)
        assertTrue(stringMatch("Location", obj.resourceType))
    ...
    @Test
    fun `location-example-patients-home 840 Test`() {
        val json = File("./src/test/resources/model/sample_data/location-example-patients-home.json").readTextAndClose()
        val obj = mapper.fromJson(json, Location::class.java)
        assertTrue(stringMatch("Location", obj.resourceType))
    ...
    @Test
    fun `location-example-hl7hq 841 Test`() {
        val json = File("./src/test/resources/model/sample_data/location-example-hl7hq.json").readTextAndClose()
        val obj = mapper.fromJson(json, Location::class.java)
        assertTrue(stringMatch("Location", obj.resourceType))
    ...
    @Test
    fun `location-example-hl7hq 842 Test`() {
        val json = File("./src/test/resources/model/sample_data/location-example-hl7hq.json").readTextAndClose()
        val obj = mapper.fromJson(json, Location::class.java)
