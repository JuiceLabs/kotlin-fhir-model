...
class SubstanceDataTest : DataTests() {
    @Test
    fun `substance-example-silver-nitrate-product 681 Test`() {
        val json = File("./src/test/resources/model/sample_data/substance-example-silver-nitrate-product.json").readTextAndClose()
    ...
    @Test
    fun `substance-example-silver-nitrate-product 682 Test`() {
        val json = File("./src/test/resources/model/sample_data/substance-example-silver-nitrate-product.json").readTextAndClose()
        val obj = mapper.fromJson(json, Substance::class.java)
        ...
        assertEquals("2018-01-01", obj.instance[0].expiry.toString())
    ...
    @Test
    fun `substance-example-amoxicillin-clavulanate 683 Test`() {
        val json = File("./src/test/resources/model/sample_data/substance-example-amoxicillin-clavulanate.json").readTextAndClose()
        val obj = mapper.fromJson(json, Substance::class.java)
        assertTrue(stringMatch("Substance", obj.resourceType))
    ...
    @Test
    fun `substance-example-f203-potassium 684 Test`() {
        val json = File("./src/test/resources/model/sample_data/substance-example-f203-potassium.json").readTextAndClose()
        val obj = mapper.fromJson(json, Substance::class.java)
        assertTrue(stringMatch("Substance", obj.resourceType))
    ...
    @Test
    fun `substance-example-f201-dust 685 Test`() {
        val json = File("./src/test/resources/model/sample_data/substance-example-f201-dust.json").readTextAndClose()
        val obj = mapper.fromJson(json, Substance::class.java)
        assertTrue(stringMatch("Substance", obj.resourceType))
    ...
    @Test
    fun `substance-example 686 Test`() {
        val json = File("./src/test/resources/model/sample_data/substance-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Substance::class.java)
    }

    @Test
    fun `substance-example 687 Test`() {
        val json = File("./src/test/resources/model/sample_data/substance-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, Substance::class.java)
        assertTrue(stringMatch("Substance", obj.resourceType))
    ...
    @Test
    fun `substance-example-f202-staphylococcus 688 Test`() {
        val json = File("./src/test/resources/model/sample_data/substance-example-f202-staphylococcus.json").readTextAndClose()
        val obj = mapper.fromJson(json, Substance::class.java)
        assertTrue(stringMatch("Substance", obj.resourceType))
