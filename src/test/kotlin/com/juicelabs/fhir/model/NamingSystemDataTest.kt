...
class NamingSystemDataTest : DataTests() {
    @Test
    fun `namingsystem-example-id 944 Test`() {
        val json = File("./src/test/resources/model/sample_data/namingsystem-example-id.json").readTextAndClose()
        ...
        assertEquals("2015-08-31", obj.date.toString())
        ...
        assertEquals("2015-08-21", obj.uniqueId[1].period!!.start.toString())
    }

    @Test
    fun `namingsystem-example-replaced 945 Test`() {
        val json = File("./src/test/resources/model/sample_data/namingsystem-example-replaced.json").readTextAndClose()
        val obj = mapper.fromJson(json, NamingSystem::class.java)
        assertTrue(stringMatch("NamingSystem", obj.resourceType))
        ...
        assertEquals("2005-01-25", obj.date.toString())
    ...
    @Test
    fun `namingsystem-example 946 Test`() {
        val json = File("./src/test/resources/model/sample_data/namingsystem-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, NamingSystem::class.java)
        assertTrue(stringMatch("NamingSystem", obj.resourceType))
        ...
        assertTrue(stringMatch("active", obj.status))
        assertTrue(stringMatch("codesystem", obj.kind))
        assertEquals("2014-12-13", obj.date.toString())
    ...
    @Test
    fun `namingsystem-example 947 Test`() {
        val json = File("./src/test/resources/model/sample_data/namingsystem-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, NamingSystem::class.java)
        assertTrue(stringMatch("uri", obj.uniqueId[1].type))
