...
class ImagingManifestDataTest : DataTests() {
    @Test
    fun `imagingmanifest-example 832 Test`() {
        val json = File("./src/test/resources/model/sample_data/imagingmanifest-example.json").readTextAndClose()
        ...
        assertEquals("2014-11-20T11:01:20-08:00", obj.authoringTime.toString())
