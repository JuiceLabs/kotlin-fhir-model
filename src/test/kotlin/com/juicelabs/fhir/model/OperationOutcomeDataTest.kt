...
class OperationOutcomeDataTest : DataTests() {
    @Test
    fun `operationoutcome-example-validationfail 639 Test`() {
        val json = File("./src/test/resources/model/sample_data/operationoutcome-example-validationfail.json").readTextAndClose()
    ...
    @Test
    fun `operationoutcome-example-break-the-glass 640 Test`() {
        val json = File("./src/test/resources/model/sample_data/operationoutcome-example-break-the-glass.json").readTextAndClose()
        val obj = mapper.fromJson(json, OperationOutcome::class.java)
        assertTrue(stringMatch("OperationOutcome", obj.resourceType))
    ...
    @Test
    fun `operationoutcome-example-searchfail 641 Test`() {
        val json = File("./src/test/resources/model/sample_data/operationoutcome-example-searchfail.json").readTextAndClose()
        val obj = mapper.fromJson(json, OperationOutcome::class.java)
        assertTrue(stringMatch("OperationOutcome", obj.resourceType))
    ...
    @Test
    fun `operationoutcome-example-exception 642 Test`() {
        val json = File("./src/test/resources/model/sample_data/operationoutcome-example-exception.json").readTextAndClose()
        val obj = mapper.fromJson(json, OperationOutcome::class.java)
        assertTrue(stringMatch("OperationOutcome", obj.resourceType))
    ...
    @Test
    fun `operationoutcome-example 643 Test`() {
        val json = File("./src/test/resources/model/sample_data/operationoutcome-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, OperationOutcome::class.java)
        assertTrue(stringMatch("OperationOutcome", obj.resourceType))
    ...
    @Test
    fun `operationoutcome-example 644 Test`() {
        val json = File("./src/test/resources/model/sample_data/operationoutcome-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, OperationOutcome::class.java)
    ...
    @Test
    fun `operationoutcome-example-allok 645 Test`() {
        val json = File("./src/test/resources/model/sample_data/operationoutcome-example-allok.json").readTextAndClose()
        val obj = mapper.fromJson(json, OperationOutcome::class.java)
        assertTrue(stringMatch("OperationOutcome", obj.resourceType))
