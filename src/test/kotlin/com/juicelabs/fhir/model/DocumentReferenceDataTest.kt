...
class DocumentReferenceDataTest : DataTests() {
    @Test
    fun `documentreference-example 993 Test`() {
        val json = File("./src/test/resources/model/sample_data/documentreference-example.json").readTextAndClose()
    ...
    @Test
    fun `documentreference-example 994 Test`() {
        val json = File("./src/test/resources/model/sample_data/documentreference-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, DocumentReference::class.java)
        ...
        assertEquals("2005-12-24T09:35:00+11:00", obj.created.toString())
        assertEquals("2005-12-24T09:43:41+11:00", obj.indexed.toString())
        ...
        assertEquals("2004-12-23T08:00:00+11:00", obj.context!!.period!!.start.toString())
        assertEquals("2004-12-23T08:01:00+11:00", obj.context!!.period!!.end.toString())
