...
class RiskAssessmentDataTest : DataTests() {
    @Test
    fun `riskassessment-example-population 737 Test`() {
    ...
    @Test
    fun `riskassessment-example-cardiac 738 Test`() {
        ...
        assertEquals("2014-07-19T16:04:00Z", obj.occurrenceDateTime.toString())
    ...
    @Test
    fun `riskassessment-example 739 Test`() {
    ...
    @Test
    fun `riskassessment-example 740 Test`() {
        val json = File("./src/test/resources/model/sample_data/riskassessment-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, RiskAssessment::class.java)
        assertTrue(stringMatch("BRCAPRO", obj.method!!.coding[0].code))
        assertEquals("2006-01-13T23:01:00Z", obj.occurrenceDateTime.toString())
    ...
    @Test
    fun `riskassessment-example 741 Test`() {
        val json = File("./src/test/resources/model/sample_data/riskassessment-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, RiskAssessment::class.java)
    ...
    @Test
    fun `riskassessment-example-prognosis 742 Test`() {
        ...
        assertTrue(stringMatch("<div xmlns=\"http://www.w3.org", obj.text!!.div))
        assertTrue(stringMatch("final", obj.status))
        assertEquals("2010-11-22", obj.occurrenceDateTime.toString())
