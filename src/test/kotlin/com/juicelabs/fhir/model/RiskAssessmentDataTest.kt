...
class RiskAssessmentDataTest : DataTests() {
    ...
    fun `riskassessment-example-population 401 Test`() {
        val json = File("./src/test/resources/model/sample_data/riskassessment-example-population.json").readTextAndClose()
    ...
    fun `riskassessment-example-cardiac 402 Test`() {
        val json = File("./src/test/resources/model/sample_data/riskassessment-example-cardiac.json").readTextAndClose()
        val obj = mapper.fromJson(json, RiskAssessment::class.java)
        assertTrue(stringMatch("RiskAssessment", obj.resourceType))
    ...
    fun `riskassessment-example 403 Test`() {
        val json = File("./src/test/resources/model/sample_data/riskassessment-example.json").readTextAndClose()
        val obj = mapper.fromJson(json, RiskAssessment::class.java)
        assertTrue(stringMatch("RiskAssessment", obj.resourceType))
    ...
    fun `riskassessment-example-prognosis 404 Test`() {
        val json = File("./src/test/resources/model/sample_data/riskassessment-example-prognosis.json").readTextAndClose()
        val obj = mapper.fromJson(json, RiskAssessment::class.java)
        assertTrue(stringMatch("RiskAssessment", obj.resourceType))
